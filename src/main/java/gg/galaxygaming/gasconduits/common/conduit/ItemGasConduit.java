...
public class ItemGasConduit extends AbstractItemConduit implements IAdvancedTooltipProvider {
    ...
    protected ItemGasConduit(@Nonnull IModObject modObject) {
        ...
        ConduitRegistry
                .register(ConduitBuilder.start().setUUID(new ResourceLocation(GasConduitsConstants.MOD_ID, "gas"))
                        ...
                        .setUUID(new ResourceLocation(GasConduitsConstants.MOD_ID, "ender_gas_conduit"))

...
public class BlockPowerMonitor extends AbstractMachineBlock<TilePowerMonitor>
                               implements IAdvancedTooltipProvider, IPaintable.ISolidBlockPaintableBlock,
    ...
    @Deprecated
    @Override
    public int getWeakPower(@Nonnull IBlockState blockStateIn, @Nonnull IBlockAccess blockAccess, @Nonnull BlockPos pos,

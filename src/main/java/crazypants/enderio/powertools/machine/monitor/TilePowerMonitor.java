...
@Storable
public class TilePowerMonitor extends AbstractPoweredTaskEntity
                              implements IPaintableTileEntity, DynaTextureProviderPMon.IDataProvider {
    ...
    /**
     * Forces neighbors to be kicked regardless of power change. Used to make sure state is propagated correctly after
     * being loaded in from the save.
     */
    private boolean initialized = false;

    public TilePowerMonitor() {
        super(new SlotDefinition(0, 0, 0), POWER_MONITOR_POWER_INTAKE, POWER_MONITOR_POWER_BUFFER,
                POWER_MONITOR_POWER_USE);
    }

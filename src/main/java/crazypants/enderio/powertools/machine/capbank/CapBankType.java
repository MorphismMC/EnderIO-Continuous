...
public enum CapBankType implements IStringSerializable {
    ...
    CREATIVE("CREATIVE", "tile.block_cap_bank.creative", CapBankConfig.tierC_maxIO, CapBankConfig.tierC_maxStorage,
            false, true),

    SIMPLE("SIMPLE", "tile.block_cap_bank.simple", CapBankConfig.tier1_maxIO, CapBankConfig.tier1_maxStorage, true,
            false),

    ACTIVATED("ACTIVATED", "tile.block_cap_bank.activated", CapBankConfig.tier2_maxIO, CapBankConfig.tier2_maxStorage,
            true, false),

    VIBRANT("VIBRANT", "tile.block_cap_bank.vibrant", CapBankConfig.tier3_maxIO, CapBankConfig.tier3_maxStorage, true,
            false),
    ...
    public static final @Nonnull PropertyEnum<CapBankType> KIND = NullHelper.notnullM(
            PropertyEnum.<CapBankType>create("kind", CapBankType.class),
            "PropertyEnum.create()");
    ...
    private CapBankType(@Nonnull String uid, @Nonnull String unlocalizedName, @Nonnull IValue<Integer> maxIO,
                        @Nonnull IValue<Integer> maxStored,

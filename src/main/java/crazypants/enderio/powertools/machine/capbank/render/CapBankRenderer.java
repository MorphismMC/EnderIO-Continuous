...
public class CapBankRenderer extends ManagedTESR<TileCapBank> {
    ...
    private static final Map<InfoDisplayType, IInfoRenderer> infoRenderers = new EnumMap<InfoDisplayType, IInfoRenderer>(
            InfoDisplayType.class);
    static {
    ...
    @Override
    protected void renderTileEntity(@Nonnull TileCapBank te, @Nonnull IBlockState blockState, float partialTicks,
                                    int destroyStage) {

...
public class ClientUtil {
    ...
    public static void regRenderer(@Nonnull Block block, int meta, @Nonnull String name) {
        ...
        if (resourceLocation == null) {
            throw new NullPointerException("Cannot register renderers for block " + block +
                    ": Block is not registered with the block registry");
        }
    ...
    public static void spawnParcticles(double posX, double posY, double posZ, int count,
                                       @Nonnull EnumParticleTypes particle) {

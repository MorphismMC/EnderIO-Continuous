...
/**
 * An int-int mapping that has a low memory footprint and reasonable lookup times but slow insert times. It also can
 * save and load from/to nbt.
 * <p>
...
public class SparseArray {
    ...
    /**
     * If there are any mappings, stores them in a {@link NBTTagCompound} and returns that. If there are no mappings,
    ...
    /**
     * Creates a new object with the mappings stored in the given {@link NBTTagCompound}. If the {@link NBTTagCompound}
     * is null or doesn't have any mappings, an

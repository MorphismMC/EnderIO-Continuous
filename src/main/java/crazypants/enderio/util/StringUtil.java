...
public class StringUtil {
    ...
    public static void sendEnabledChatMessage(final @Nonnull EntityPlayer player, @Nonnull String messageBase,
                                              boolean isActive) {
        player.sendStatusMessage(new TextComponentTranslation(messageBase + (isActive ? ".enabled" : ".disabled")),
                true);
    }
}

...
public class Neighbours extends BlockPos implements Iterable<Neighbours>, Iterator<Neighbours> {
    ...
    /**
     * If the position was shifted it gives the direction of the shift. If not, it throws an
     * {@link ArrayIndexOutOfBoundsException} to be {@link Nonnull}.
     */
    ...
    /**
     * If the position was shifted it gives the direction opposite to the shift. If not, it throws an
     * {@link ArrayIndexOutOfBoundsException} to be
     * {@link Nonnull}.
     */
    ...
    /**
     * See {@link Iterable#iterator()}. Please note that next() will always return the base {@link Neighbours} object
     * which also means that iterators are not
     * independent.
     */
    @Override

...
public interface WorldTarget {
    ...
    class BlockPosTarget implements WorldTarget {
        ...
        public IBlockState read() {
            World world2 = targetWorld.get();
            return world2 != null && world2.isBlockLoaded(targetPos) ? world2.getBlockState(targetPos) :
                    WorldTarget.super.read();
        }
    }
    ...
    static @Nonnull WorldTarget ofBlockState(@Nonnull World world, @Nonnull BlockPos pos,

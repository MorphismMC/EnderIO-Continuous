...
public class ApiaristArmorUpgrade extends AbstractUpgrade {
    ...
    protected ApiaristArmorUpgrade(@Nonnull EntityEquipmentSlot slot) {
        super(EnderIOIntegrationForestry.MODID, UPGRADE_NAME + slot.getName(),
                "enderio.darksteel.upgrade.apiarist_armor." + slot.getName(),
    ...
    public List<IRule> getRules() {
        return new NNList<>(Rules.forSlot(slot),
                Rules.or(Rules.callbacksFor(this), Rules.staticCheck(item -> item instanceof ItemDarkSteelArmor)),

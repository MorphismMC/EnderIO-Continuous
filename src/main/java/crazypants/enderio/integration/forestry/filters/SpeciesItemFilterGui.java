...
public class SpeciesItemFilterGui extends AbstractFilterGui {
    ...
    public SpeciesItemFilterGui(@Nonnull InventoryPlayer playerInv, @Nonnull ContainerFilter filterContainer,
        ...
        x += 20;
        stickyB = new ToggleButton(this, ID_STICKY + buttonIdOffset, x, y, IconEIO.FILTER_STICKY_OFF,
                IconEIO.FILTER_STICKY);
        stickyB.setSelectedToolTip(Lang.GUI_ITEM_FILTER_STICKY_ENABLED.get(),
                Lang.GUI_ITEM_FILTER_STICKY_ENABLED_2.get());
        ...
        speciesModeB = new CycleButton<SpeciesMode.IconHolder>(this, ID_SPECIES_MODE + buttonIdOffset, x, y,
                SpeciesMode.IconHolder.class);
    }

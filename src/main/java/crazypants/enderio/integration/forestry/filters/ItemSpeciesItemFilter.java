...
public class ItemSpeciesItemFilter extends Item implements ItemFilterItemUpgrade, IResourceTooltipProvider {
    ...
    public ItemFilter createFilterFromStack(@Nonnull ItemStack stack) {
        ItemFilter filter = new SpeciesItemFilter();
    ...
    public ActionResult<ItemStack> onItemRightClick(@Nonnull World world, @Nonnull EntityPlayer player,
        ...
        if (!world.isRemote && player.isSneaking()) {
            ForestryIntegrationObject.itemSpeciesItemFilter.openGui(world, player.getPosition(), player, null,
                    hand.ordinal());

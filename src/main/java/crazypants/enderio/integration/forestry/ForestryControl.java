...
public class ForestryControl {
    ...
    public static void registerFarmers(@Nonnull RegistryEvent.Register<IFarmerJoe> event) {
        ...
        if (farmer.isValid()) {
            ...
            Log.warn(
                    "Farming Station: Forestry integration for farming loaded but could not get species root for 'rootTrees'.");
        }
    }
    ...
    public static void registerFertilizer(@Nonnull RegistryEvent.Register<IFertilizer> event) {
        ...
        if (fertilizer.isValid()) {
            ...
            Log.warn(
                    "Farming Station: Forestry integration for fertilizing loaded but could not find Forestry fertilizer.");
        }
    }

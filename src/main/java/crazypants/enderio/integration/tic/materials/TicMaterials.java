...
public class TicMaterials {
    ...
    static {
        DATA.put(Alloy.ELECTRICAL_STEEL, new Data() {
            ...
            @Override
            public void stats() {
                TinkerRegistry.addMaterialStats(getMaterial(),
                        new HeadMaterialStats(306, 6.50f, 2.25f, HarvestLevels.DIAMOND),
                        new HandleMaterialStats(0.75f, 80),
        ...
        DATA.put(Alloy.ENERGETIC_ALLOY, new Data() {
            ...
            public void stats() {
                TinkerRegistry.addMaterialStats(getMaterial(),
                        new HeadMaterialStats(690, 2.50f, 5.60f, HarvestLevels.OBSIDIAN),
                        new HandleMaterialStats(2.00f, -800),
        ...
        DATA.put(Alloy.VIBRANT_ALLOY, new Data() {
            ...
            public void stats() {
                TinkerRegistry.addMaterialStats(getMaterial(),
                        new HeadMaterialStats(220, 3.50f, 9.00f, HarvestLevels.COBALT),
        ...
        DATA.put(Alloy.REDSTONE_ALLOY, new Data() {
            ...
            @Override
            public void stats() {
                TinkerRegistry.addMaterialStats(getMaterial(), new HeadMaterialStats(120, 2.50f, 1.50f, STONE),
                        new HandleMaterialStats(1.00f, -5),
        ...
        DATA.put(Alloy.CONDUCTIVE_IRON, new Data() {
            ...
            public void stats() {
                TinkerRegistry.addMaterialStats(getMaterial(),
                        new HeadMaterialStats(106, 6.75f, 1.25f, HarvestLevels.DIAMOND),
        ...
        DATA.put(Alloy.PULSATING_IRON, new Data() {
            ...
            public void stats() {
                TinkerRegistry.addMaterialStats(getMaterial(),
                        new HeadMaterialStats(920, 6.00f, 2.00f, HarvestLevels.IRON),
                        new HandleMaterialStats(1.05f, 250),
        ...
        DATA.put(Alloy.DARK_STEEL, new Data() {
            ...
            public void stats() {
                TinkerRegistry.addMaterialStats(getMaterial(),
                        new HeadMaterialStats(550, 7.00f, 6.00f, DarkSteelConfig.miningLevel.get(0).get()),
                        new HandleMaterialStats(0.9f, 150), new ExtraMaterialStats(250),
                        new BowMaterialStats(0.3f, 2.5f, 9f));
            }
        });
        ...
        DATA.put(Alloy.SOULARIUM, new Data() {
            ...
            public void stats() {
                TinkerRegistry.addMaterialStats(getMaterial(),
                        new HeadMaterialStats(1555, 1.00f, 1.00f, HarvestLevels.STONE),
                        new HandleMaterialStats(0.5f, 1500),
                        new ExtraMaterialStats(1250), new BowMaterialStats(0.1f, 0.5f, 0f),
        ...
        DATA.put(Alloy.END_STEEL, new Data() {
            ...
            public void stats() {
                TinkerRegistry.addMaterialStats(getMaterial(),
                        new HeadMaterialStats(400, 8.25f, 5.00f, DarkSteelConfig.miningLevel.get(1).get()),
                        new HandleMaterialStats(0.9f, 50), new ExtraMaterialStats(150),
                        new BowMaterialStats(0.3f, 2.5f, 9f));
            }
        });
        ...
        DATA.put(Alloy.CONSTRUCTION_ALLOY, new Data() {
            ...
            public void stats() {
                TinkerRegistry.addMaterialStats(getMaterial(),
                        new HeadMaterialStats(50, 1.25f, 1.00f, HarvestLevels.IRON), new HandleMaterialStats(0.5f, 10),

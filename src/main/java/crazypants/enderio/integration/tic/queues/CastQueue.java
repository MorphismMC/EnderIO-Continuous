...
public class CastQueue {
    ...
    public CastQueue(@Nonnull Things result, @Nonnull Things cast, @Nonnull Things item, float amount,
                     boolean consumeCast) {
        this.result = result;
        this.cast = cast;
        this.item = item;
    ...
    public CastQueue(@Nonnull Things result, @Nonnull Things cast, @Nonnull Fluid fluid, float amount,
                     boolean consumeCast) {
        this.result = result;
        this.cast = cast;
        this.item = null;

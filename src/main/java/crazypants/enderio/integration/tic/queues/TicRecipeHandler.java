...
public class TicRecipeHandler implements ITicRecipeHandler {
    ...
    @Override
    public void registerTableCast(@Nonnull Things output, @Nonnull Things cast, Fluid fluid, float amount,
                                  boolean consumeCast) {
    ...
    @Override
    public void registerTableCast(@Nonnull Things output, @Nonnull Things cast, @Nonnull Things fluid, float amount,
                                  boolean consumeCast) {
    ...
    @Override
    public void registerBasinCasting(@Nonnull Things output, @Nonnull Things cast, @Nonnull Things fluid,
                                     float amount) {

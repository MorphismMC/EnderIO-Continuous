...
public class Glowstone {
    ...
    private static final ResourceLocation GLOWSTONE_TEX_STILL = new ResourceLocation(
            "enderio:blocks/fluid_glowstone_still");
    private static final ResourceLocation GLOWSTONE_TEX_FLOWING = new ResourceLocation(
            "enderio:blocks/fluid_glowstone_flow");
    ...
    public static void createFluid() {
        ...
        }.setUnlocalizedName(EnderIO.DOMAIN + "." + TicProxy.GLOWSTONE_FLUID_NAME).setDensity(-500).setGaseous(true)
                .setTemperature(1500 + 273).setViscosity(100);

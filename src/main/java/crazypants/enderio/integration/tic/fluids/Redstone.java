...
public class Redstone {
    ...
    private static final ResourceLocation TEX_STILL = new ResourceLocation(
    ...
    public static void createFluid() {
        ...
        }.setUnlocalizedName(EnderIO.DOMAIN + "." + TicProxy.REDSTONE_FLUID_NAME).setDensity(1200)
                .setTemperature(1700 + 273).setViscosity(1500);
    ...
    public static void registerRedstoneRecipes() {
        ...
        if (f != null) {
            ...
            TicRecipeHandler.instance.registerBasinCasting(new Things().add(Blocks.REDSTONE_BLOCK), new Things(), f,
                    900);
        }
    }
}

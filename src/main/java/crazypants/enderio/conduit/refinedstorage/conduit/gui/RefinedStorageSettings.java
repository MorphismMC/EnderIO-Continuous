...
public class RefinedStorageSettings extends BaseSettingsPanel {
    ...
    public RefinedStorageSettings(@Nonnull IGuiExternalConnection gui, @Nonnull IClientConduit con) {
        ...
        filterInsertUpgradeTooltip = new GuiToolTip(new Rectangle(leftColumn, 70, 18, 18),
                Lang.GUI_RS_FILTER_UPGRADE_OUT.get(),
    ...
    protected void initCustomOptions() {
        ...
        NNList<ItemStack> filtersAll = new NNList<>(new ItemStack(ModObject.itemBasicItemFilter.getItemNN()),
                new ItemStack(ModObject.itemFluidFilter.getItemNN()));
        NNList<ItemStack> upgrades = new NNList<>(new ItemStack(ConduitObject.item_extract_speed_upgrade.getItemNN()),
                ...
                new ItemStack(ConduitRefinedStorageObject.item_rs_crafting_upgrade.getItemNN()),
        ...
        gui.getContainer().createGhostSlots(gui.getGhostSlotHandler().getGhostSlots(), filtersAll, filtersAll,
                upgrades);
    }
}

package crazypants.enderio.conduit.gas.common.config;
...
public final class GasConduitConfig {
    ...
    public static final IValue<Integer> tier1_maxIO = F.make("tier1_maxIO", 256,
            "Millibuckets per tick that can pass through a single connection to a gas conduit.").setRange(1, MAX_IO)
            .sync();

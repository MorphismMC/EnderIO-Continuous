...
public class PacketHandler {
    ...
    public static final @Nonnull ThreadedNetworkWrapper INSTANCE = new ThreadedNetworkWrapper("eiococ"); // sic!
                                                                                                         // EnderIOConduitsOpenComputers.MODID
                                                                                                         // is too long
                                                                                                         // sic! not
                                                                                                         // DOMAIN!
    ...
    public static void init(FMLInitializationEvent event) {
        INSTANCE.registerMessage(PacketOCConduitSignalColor.Handler.class, PacketOCConduitSignalColor.class, nextID(),
                Side.SERVER);
    }
}

...
public class OCConduitImpl extends AbstractConduit implements OCConduit {
    ...
    public OCConduitImpl() {
        super();
    }

    public OCConduitImpl(int meta) {
        super();
    }
    ...
    public Collection<CollidableComponent> createCollidables(@Nonnull CacheKey key) {
        ...
        CollidableComponent cc = new CollidableComponent(OCConduit.class, bb, keydir, COLOR_CONTROLLER_ID);
                ...
                if (network != null) {
                    ...
                    if (noconnections) {
                        player.sendMessage(new TextComponentString(
                                "No connections at " + bc.getX() + "/" + bc.getY() + "/" + bc.getZ()));
                    }
                } else {
                    player.sendMessage(
                            new TextComponentString("No network at " + bc.getX() + "/" + bc.getY() + "/" + bc.getZ()));
                }
            }
            return true;
     ...
     * all the node's blocks are adjacent to us.

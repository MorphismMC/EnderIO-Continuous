...
public class AdvancedLiquidConduitNetwork extends AbstractTankConduitNetwork<AdvancedLiquidConduit> {
    ...
    public FluidStack drain(FluidStack resource, boolean doDrain) {
        if (resource == null || tank.isEmpty() || !tank.containsValidLiquid() ||
    ...
    public boolean extractFrom(@Nonnull AdvancedLiquidConduit advancedLiquidConduit, @Nonnull EnumFacing dir,

...
public final class ConduitConfig {
    ...
    public static final IValue<Boolean> updateLightingWhenHidingFacades = F.make("updateLightingWhenHidingFacades",
            false, //
    ...
    public static final IValue<Boolean> transparentFacadesLetThroughBeaconBeam = F.make(
            "transparentFacadesLetThroughBeaconBeam", true, //
            "If enabled, transparent facades will not block the Beacon's beam. As side effect they will also let through a tiny amount of light.")
            .sync();
    ...
    public static final IValue<Integer> fluid_tier1_maxIO = FF.make("tier1_maxIO", 200, //
            "Millibuckets per tick that can pass through a single connection to a fluid conduit.").setRange(1, MAXIO)
            .sync();
    public static final IValue<Integer> fluid_tier2_extractRate = FF.make("tier2_extractRate", 100, //
            "Millibuckets per tick extracted by a pressurized fluid conduit's auto extracting.").setRange(1, MAXIO)
            .sync();
    public static final IValue<Integer> fluid_tier2_maxIO = FF.make("tier2_maxIO", 400, //
            "Millibuckets per tick that can pass through a single connection to a pressurized fluid conduit.")
            .setRange(1, MAXIO).sync();
    ...
    public static final IValue<Integer> fluid_tier3_maxIO = FF.make("tier3_maxIO", 800, //
            "Millibuckets per tick that can pass through a single connection to a ender fluid conduit.")
            .setRange(1, MAXIO).sync();

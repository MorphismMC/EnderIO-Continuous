...
public class BakedQuadBuilder {
    ...
    public static void addBakedQuads(@Nonnull List<BakedQuad> quads, @Nonnull BoundingBox bound,
                                     @Nonnull TextureAtlasSprite tex) {
        RenderUtil.addBakedQuads(quads, bound, tex);
    }

    public static void addBakedQuads(@Nonnull List<BakedQuad> quads, @Nonnull BoundingBox bound, @Nonnull Vector4f uvs,
                                     @Nonnull TextureAtlasSprite tex) {
        RenderUtil.addBakedQuads(quads, bound, uvs, tex);
    }

    public static void addBakedQuads(@Nonnull List<BakedQuad> quads, @Nonnull BoundingBox bound,
                                     @Nonnull TextureAtlasSprite tex, Vector4f color) {
        RenderUtil.addBakedQuads(quads, bound, tex, color);
    }

    public static void addBakedQuads(@Nonnull List<BakedQuad> quads, @Nonnull List<Vertex> vertices,
                                     @Nonnull TextureAtlasSprite tex, Vector4f color) {
    ...
    public static void addBakedQuadForFace(@Nonnull List<BakedQuad> quads, @Nonnull BoundingBox bb,
                                           @Nonnull TextureAtlasSprite tex, @Nonnull EnumFacing dir) {

...
public class ConduitBundleRenderManager {
    ...
    public static final @Nonnull TextureSupplier connectorIconExternal = TextureRegistry
            .registerTexture("blocks/conduit_connector");

    public static final @Nonnull TextureSupplier connectorIcon = TextureRegistry
            .registerTexture("blocks/conduit_connector"); // TODO: is this even used?

...
public class InventoryUpgrades implements IItemHandlerModifiable {
    ...
    public ItemStack getStackInSlot(int slot) {
        switch (slot) {
            ...
            case 2:
                return filterHolder != null ? filterHolder.getFilterStack(filterHolder.getInputFilterIndex(), dir) :
                        ItemStack.EMPTY;
            case 3:
                return filterHolder != null ? filterHolder.getFilterStack(filterHolder.getOutputFilterIndex(), dir) :
                        ItemStack.EMPTY;
            default:

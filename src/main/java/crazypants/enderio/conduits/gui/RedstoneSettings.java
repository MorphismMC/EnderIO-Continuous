...
public class RedstoneSettings extends BaseSettingsPanel {
    ...
    public boolean updateConduit(@Nonnull ConduitClient conduit) {
        ...
        final ConnectionMode connectionMode = con.containsExternalConnection(gui.getDir()) ?
                con.getConnectionMode(gui.getDir()) : ConnectionMode.NOT_SET;
    ...
    private void createGhostSlots() {
        NNList<ItemStack> filtersOut = new NNList<>( //
                new ItemStack(ModObject.itemRedstoneAndFilter.getItemNN()),
                new ItemStack(ModObject.itemRedstoneNandFilter.getItemNN()),
                new ItemStack(ModObject.itemRedstoneNorFilter.getItemNN()),
                new ItemStack(ModObject.itemRedstoneNotFilter.getItemNN()),
                new ItemStack(ModObject.itemRedstoneOrFilter.getItemNN()),
                new ItemStack(ModObject.itemRedstoneToggleFilter.getItemNN()),
                new ItemStack(ModObject.itemRedstoneXnorFilter.getItemNN()),
                new ItemStack(ModObject.itemRedstoneXorFilter.getItemNN()));
        NNList<ItemStack> filtersIn = new NNList<>( //
                new ItemStack(ModObject.itemRedstoneSensorFilter.getItemNN()),
                new ItemStack(ModObject.itemRedstoneTimerFilter.getItemNN()));

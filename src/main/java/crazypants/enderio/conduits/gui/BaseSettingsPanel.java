...
public class BaseSettingsPanel extends Gui implements ITabPanel, IOpenFilterRemoteExec.GUI {
    ...
    protected BaseSettingsPanel(@Nonnull IWidgetIcon icon, @Nonnull String typeName,
        ...
        filterExtractUpgradeTooltip = new GuiToolTip(new Rectangle(rightColumn, 70, 18, 18),
                Lang.GUI_ITEM_FILTER_UPGRADE.get()) {
        ...
        functionUpgradeTooltip = new GuiToolTip(new Rectangle(rightColumn + 18, customTop + 43, 18, 18),
                Lang.GUI_ITEM_FUNCTION_UPGRADE.get(),

...
public enum CapacitorKey implements ICapacitorKey {
    ...
    SIMPLE_ALLOY_SMELTER_POWER_INTAKE(MachineObject.block_simple_alloy_smelter, CapacitorKeyType.ENERGY_INTAKE,
            "intake"),
    SIMPLE_ALLOY_SMELTER_POWER_BUFFER(MachineObject.block_simple_alloy_smelter, CapacitorKeyType.ENERGY_BUFFER,
            "buffer"),
    ...
    ENHANCED_ALLOY_SMELTER_POWER_INTAKE(MachineObject.block_enhanced_alloy_smelter, CapacitorKeyType.ENERGY_INTAKE,
            "intake"),
    ENHANCED_ALLOY_SMELTER_POWER_BUFFER(MachineObject.block_enhanced_alloy_smelter, CapacitorKeyType.ENERGY_BUFFER,
            "buffer"),
    ENHANCED_ALLOY_SMELTER_POWER_USE(MachineObject.block_enhanced_alloy_smelter, CapacitorKeyType.ENERGY_USE, "use"),
    ENHANCED_ALLOY_SMELTER_POWER_EFFICIENCY(MachineObject.block_enhanced_alloy_smelter, CapacitorKeyType.ENERGY_BUFFER,
            "efficiency"),
    ENHANCED_ALLOY_SMELTER_DOUBLE_OP_CHANCE(MachineObject.block_enhanced_alloy_smelter, CapacitorKeyType.AMOUNT,
            "double_op_chance"),
    ...
    ENHANCED_COMBUSTION_POWER_LOSS(MachineObject.block_enhanced_combustion_generator, CapacitorKeyType.ENERGY_LOSS,
            "loss"),
    ENHANCED_COMBUSTION_POWER_BUFFER(MachineObject.block_enhanced_combustion_generator, CapacitorKeyType.ENERGY_BUFFER,
            "buffer"),
    ENHANCED_COMBUSTION_POWER_GEN(MachineObject.block_enhanced_combustion_generator, CapacitorKeyType.ENERGY_GEN,
            "gen"),
    ENHANCED_COMBUSTION_POWER_SEND(MachineObject.block_enhanced_combustion_generator, CapacitorKeyType.ENERGY_INTAKE,
            "send"),
    ENHANCED_COMBUSTION_POWER_EFFICIENCY(MachineObject.block_enhanced_combustion_generator,
            CapacitorKeyType.ENERGY_EFFICIENCY, "efficiency"),
    ...
    SIMPLE_STIRLING_POWER_BUFFER(MachineObject.block_simple_stirling_generator, CapacitorKeyType.ENERGY_BUFFER,
            "buffer"),
    ...
    ENHANCED_SAG_MILL_POWER_EFFICIENCY(MachineObject.block_enhanced_sag_mill, CapacitorKeyType.ENERGY_EFFICIENCY,
            "efficiency"),
    ENHANCED_SAG_MILL_DOUBLE_OP_CHANCE(MachineObject.block_enhanced_sag_mill, CapacitorKeyType.AMOUNT,
            "double_op_chance"),
    ...
    public void validate() {
        if (scaler == ScalerFactory.INVALID || baseValue == Integer.MIN_VALUE) {
            throw new UnconfiguredCapKeyException(
                    "CapacitorKey " + getRegistryName() +
                            " has not been configured. This should not be possible and may be caused by a 3rd-party addon mod.");
        }
    }

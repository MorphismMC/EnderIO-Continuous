...
public final class KillerJoeConfig {
    ...
    public static final IValue<Double> killerJoeHooverXpHeight = F.make("killerJoeHooverXpHeight", 2.0, //
            "The distance from which XP will be gathered above and below Joe. (only used when killerMendingEnabled is enabled)")
            .setRange(1, 32).sync();
    public static final IValue<Double> killerJoeHooverXpWidth = F.make("killerJoeHooverXpWidth", 5.0, //
            "The distance from which XP will be gathered to each side of Joe. (only used when killerMendingEnabled is enabled)")
            .setRange(1, 32).sync();
    public static final IValue<Double> killerJoeHooverXpLength = F.make("killerJoeHooverXpLength", 10.0, //
            "The distance from which XP will be gathered in front of Joe. (only used when killerMendingEnabled is enabled)")
            .setRange(1, 32).sync();
    ...
    public static final IValue<Boolean> killerProvokesCreeperExplosions = F
            .make("killerProvokesCreeperExplosions", false, //

...
public final class AlloySmelterConfig {
    ...
    public static final IValue<Profile> profileSimpleAlloy = F.make("profileSimpleAlloy", Profile.SIMPLE_ALLOY, //
            "Operating profile for the Simple Alloy Smelter. Restaring the game is needed for a change to be reflected in JEI.")
            .sync();
    public static final IValue<Profile> profileSimpleFurnace = F.make("profileSimpleFurnace", Profile.SIMPLE_FURNACE, //
            "Operating profile for the Simple Furnace. Restaring the game is needed for a change to be reflected in JEI.")
            .sync();
    public static final IValue<Profile> profileNormal = F.make("profileNormal", Profile.AUTO, //
            "Operating profile for the Alloy Smelter. Restaring the game is needed for a change to be reflected in JEI.")
            .sync();
    public static final IValue<Profile> profileEnhancedAlloy = F.make("profileEnhancedAlloy", Profile.AUTO, //
            "Operating profile for the Enhanced Alloy Smelter. Restaring the game is needed for a change to be reflected in JEI.")
            .sync();

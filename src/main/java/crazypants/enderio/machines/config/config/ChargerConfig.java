...
public final class ChargerConfig {
    ...
    public static final IValue<Integer> wirelessRangeEnhancedAntennaExtension = F
            .make("wirelessRangeEnhancedAntennaExtension", 128, //
                    "The range of wireless chargers (extension antennas).")
            .setRange(1, 160).sync();

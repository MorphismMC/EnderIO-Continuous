...
public class PersonalConfig {
    ...
    public static final IValue<Boolean> enableAlloySmelterFurnaceJEIRecipes = F
            .make("enableAlloySmelterFurnaceJEI", true, //
                    "Should the Alloy Smelter have JEI recipes for Smelting?")
            .sync();

    public static final IValue<Boolean> enableAlloySmelterAlloyingJEIRecipes = F
            .make("enableAlloySmelterAlloyingJEI", true, //
                    "Should the Alloy Smelter have JEI recipes for Alloying?")
            .sync();

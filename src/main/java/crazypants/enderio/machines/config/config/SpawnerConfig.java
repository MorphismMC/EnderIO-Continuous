...
public final class SpawnerConfig {
    ...
    public static final IValue<Integer> poweredSpawnerDespawnTimeSeconds = F
            .make("poweredSpawnerDespawnTimeSeconds", 120, //
                    "Number of seconds in which spawned entities are protected from despawning")
            .setRange(0, Integer.MAX_VALUE / 20).sync();
    ...
    public static final IValue<Boolean> poweredSpawnerUseVanillaSpawnChecks = F.make(
            "poweredSpawnerUseVanillaSpawnChecks", false, //
            "If true, regular spawn checks such as lighting level and dimension will be made before spawning mobs")
            .sync();
    public static final IValue<Boolean> poweredSpawnerUseForgeSpawnChecks = F
            .make("poweredSpawnerUseForgeSpawnChecks", true, //
                    "If true, other mods can prevent spawning mobs")
            .sync();

    public static final IValue<Boolean> poweredSpawnerAddAllMobsCreative = F.make("poweredSpawnerAddAllMobsCreative",
            false, //
    ...
    public static final IValue<Boolean> homeZoneEnabled = C.make("homeZoneEnabled", true, //
            "If true, creative spawners sill set the homezone on spawned creatures. Note that bats, ghast, slimes and squid are not creatures.")
            .sync();

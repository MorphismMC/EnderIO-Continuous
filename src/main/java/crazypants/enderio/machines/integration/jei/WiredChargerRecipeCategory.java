...
public class WiredChargerRecipeCategory extends
                                        BlankRecipeCategory<WiredChargerRecipeCategory.WiredChargerRecipeWrapper> {
    ...
    public static void register() {
        ...
        MachinesPlugin.iModRegistry.addRecipeCategoryCraftingItem(
                new ItemStack(MachineObject.block_wired_charger.getBlockNN()), WiredChargerRecipeCategory.UID);
        MachinesPlugin.iModRegistry.addRecipeCategoryCraftingItem(
                new ItemStack(MachineObject.block_normal_wireless_charger.getBlockNN()),
                WiredChargerRecipeCategory.UID);
        MachinesPlugin.iModRegistry.addRecipeClickArea(GuiWiredCharger.class, 176, 42, 16, 16,
                WiredChargerRecipeCategory.UID);
        ...
        MachinesPlugin.iModRegistry.getRecipeTransferRegistry().addRecipeTransferHandler(ContainerWiredCharger.class,
                WiredChargerRecipeCategory.UID,
                ContainerWiredCharger.FIRST_RECIPE_SLOT, ContainerWiredCharger.NUM_RECIPE_SLOT,
                ContainerWiredCharger.FIRST_INVENTORY_SLOT,
                ContainerWiredCharger.NUM_INVENTORY_SLOT);

        Log.info(String.format("WiredChargerRecipeCategory: Added %d item charging recipes to JEI in %.3f seconds.",
    ...
    public WiredChargerRecipeCategory(IGuiHelper guiHelper) {
        ...
        flame = guiHelper.createAnimatedDrawable(guiHelper.createDrawable(backgroundLocation, 241, 0, 14, 37), 200,
    ...
    @SuppressWarnings("null")
    @Override
    public void setRecipe(@Nonnull IRecipeLayout recipeLayout, @Nonnull WiredChargerRecipeWrapper recipeWrapper,

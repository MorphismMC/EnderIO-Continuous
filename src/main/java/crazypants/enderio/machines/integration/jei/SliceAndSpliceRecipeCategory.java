...
public class SliceAndSpliceRecipeCategory extends
                                          BlankRecipeCategory<SliceAndSpliceRecipeCategory.SliceAndSpliceRecipe> {
    ...
    public static void register() {
        ...
        MachinesPlugin.iModRegistry.handleRecipes(IRecipe.class, SliceAndSpliceRecipe::new,
                SliceAndSpliceRecipeCategory.UID);
        MachinesPlugin.iModRegistry.addRecipeClickArea(GuiSliceAndSplice.class, 155, 42, 16, 16,
                SliceAndSpliceRecipeCategory.UID);
        MachinesPlugin.iModRegistry.addRecipeCategoryCraftingItem(new ItemStack(block_slice_and_splice.getBlockNN()),
                SliceAndSpliceRecipeCategory.UID);

        MachinesPlugin.iModRegistry.addRecipes(SliceAndSpliceRecipeManager.getInstance().getRecipes(), UID);

        MachinesPlugin.iModRegistry.getRecipeTransferRegistry().addRecipeTransferHandler(ContainerSliceAndSplice.class,
                SliceAndSpliceRecipeCategory.UID, FIRST_RECIPE_SLOT,
    ...
    public SliceAndSpliceRecipeCategory(IGuiHelper guiHelper) {
        RecipeWrapperIRecipe.setLevelData(SliceAndSpliceRecipe.class, MachinesPlugin.iGuiHelper, 138 - xOff, 4,
    ...
    public void setRecipe(@Nonnull IRecipeLayout recipeLayout,
                          @Nonnull SliceAndSpliceRecipeCategory.SliceAndSpliceRecipe recipeWrapper,

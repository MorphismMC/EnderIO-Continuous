...
public class SagMillGrindingBallCategory extends BlankRecipeCategory<SagMillGrindingBallCategory.GrindingBallWrapper> {
    ...
    public static class GrindingBallWrapper extends BlankRecipeWrapper {
        ...
        public void drawInfo(@Nonnull Minecraft minecraft, int recipeWidth, int recipeHeight, int mouseX, int mouseY) {
            ...
            fr.drawString(Lang.GRINDING_BALL_2.get("", LangPower.toPercent(ball.getGrindingMultiplier())), 48, 4,
                    0x404040);
            fr.drawString(Lang.GRINDING_BALL_3.get("", LangPower.toPercent(ball.getChanceMultiplier())), 48, 16,
                    0x404040);
            fr.drawString(Lang.GRINDING_BALL_4.get("", LangPower.toPercent(ball.getPowerMultiplier())), 48, 28,
                    0x404040);
    ...
    public static void register() {
        ...
        MachinesPlugin.iModRegistry.addRecipeCategoryCraftingItem(new ItemStack(block_sag_mill.getBlockNN()),
                SagMillGrindingBallCategory.UID);

        MachinesPlugin.iModRegistry.handleRecipes(GrindingBall.class,
                SagMillGrindingBallCategory.GrindingBallWrapper::new, SagMillGrindingBallCategory.UID);
    ...
    public SagMillGrindingBallCategory(IGuiHelper guiHelper) {
        ResourceLocation backgroundLocation = new ResourceLocation(EnderIO.DOMAIN,
                "textures/gui/jei.grinding_ball.png");
    ...
    @Override
    public void setRecipe(@Nonnull IRecipeLayout recipeLayout, @Nonnull GrindingBallWrapper recipeWrapper,

...
public class EnderGeneratorRecipeCategory extends
                                          BlankRecipeCategory<EnderGeneratorRecipeCategory.EnderGeneratorRecipeWrapper> {
    ...
    public static class EnderGeneratorRecipeWrapper extends BlankRecipeWrapper {
        ...
        public void getIngredients(@Nonnull IIngredients ingredients) {
            ingredients.setInput(FluidStack.class,
                    new FluidStack(Fluids.ENDER_DISTILLATION.getFluid(),
                            Math.round(EnderGenConfig.minimumTankLevel.get() * tankCapacity)));
            ingredients.setOutputs(EnergyIngredient.class,
                    new NNList<>(new EnergyIngredient(Math.round(CapacitorKey.ENDER_POWER_GEN.getDefaultFloat()), true),
                            new EnergyIngredient(
                                    Math.round(CapacitorKey.ENDER_POWER_GEN.get(DefaultCapacitorData.ENDER_CAPACITOR)),
                                    true)));
        }
    ...
    public static void register() {
        ...
        MachinesPlugin.iModRegistry.addRecipeCategoryCraftingItem(
                new ItemStack(MachineObject.block_ender_generator.getBlockNN(), 1, 0),
                EnderGeneratorRecipeCategory.UID);
    ...
    @Override
    public void setRecipe(@Nonnull IRecipeLayout recipeLayout, @Nonnull EnderGeneratorRecipeWrapper recipeWrapper,
        ...
        guiFluidStacks.addTooltipCallback(new ITooltipCallback<FluidStack>() {
            ...
            public void onTooltip(int slotIndex, boolean input, @Nonnull FluidStack ingredient,
                ...
                tooltip.add(Lang.GUI_ZOMBGEN_MINREQ
                        .get(LangFluid.MB(Math.round(EnderGenConfig.minimumTankLevel.get() * tankCapacity))));
            }
        });

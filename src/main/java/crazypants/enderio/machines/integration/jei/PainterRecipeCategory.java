...
public class PainterRecipeCategory implements IRecipeCategory<PainterRecipeCategory.PainterRecipeWrapper> {
    ...
    public static class PainterRecipeWrapper implements IRecipeWrapper {
        ...
        public PainterRecipeWrapper(@Nonnull AbstractPainterTemplate<?> recipe, @Nonnull ItemStack target,
                                    @Nonnull List<ItemStack> paints,
        ...
        public PainterRecipeWrapper(@Nonnull AbstractPainterTemplate<?> recipe, @Nonnull ItemStack target,
                                    @Nonnull ItemStack paint, @Nonnull ItemStack result) {
            this.recipe = recipe;
            this.target = target;
        ...
        public void getIngredients(@Nonnull IIngredients ingredients) {
            ...
            ingredients.setInput(EnergyIngredient.class,
                    new EnergyIngredient(recipe.getEnergyRequired(NNList.emptyList())));
        }
    }
    ...
    public static void register() {
        ...
        MachinesPlugin.iModRegistry.addRecipeCatalyst(new ItemStack(block_painter.getBlockNN()),
                PainterRecipeCategory.UID);

        MachinesPlugin.iModRegistry.addRecipeRegistryPlugin(new PainterRegistryPlugin(MachinesPlugin.iModRegistry));

        MachinesPlugin.iModRegistry.getRecipeTransferRegistry().addRecipeTransferHandler(ContainerPainter.class,
                PainterRecipeCategory.UID, FIRST_RECIPE_SLOT, NUM_RECIPE_SLOT,
    ...
    public void setRecipe(@Nonnull IRecipeLayout recipeLayout,
                          @Nonnull PainterRecipeCategory.PainterRecipeWrapper currentRecipe,

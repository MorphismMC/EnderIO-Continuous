...
public class SolarPanelRecipeCategory extends BlankRecipeCategory<SolarPanelRecipeCategory.SolarPanelRecipeWrapper> {
    ...
    public static void register() {
        ...
        MachinesPlugin.iModRegistry.addRecipeCategoryCraftingItem(
                new ItemStack(MachineObject.block_solar_panel.getBlockNN(), 1, 3), SolarPanelRecipeCategory.UID);
        MachinesPlugin.iModRegistry.addRecipeCategoryCraftingItem(
                new ItemStack(MachineObject.block_solar_panel.getBlockNN(), 1, 2), SolarPanelRecipeCategory.UID);
        MachinesPlugin.iModRegistry.addRecipeCategoryCraftingItem(
                new ItemStack(MachineObject.block_solar_panel.getBlockNN(), 1, 1), SolarPanelRecipeCategory.UID);
        MachinesPlugin.iModRegistry.addRecipeCategoryCraftingItem(
                new ItemStack(MachineObject.block_solar_panel.getBlockNN(), 1, 0), SolarPanelRecipeCategory.UID);
        MachinesPlugin.iModRegistry
                .addRecipes(Collections.singletonList(new SolarPanelRecipeWrapper(MachinesPlugin.iGuiHelper)), UID);
    }
    ...
    @Override
    public void setRecipe(@Nonnull IRecipeLayout recipeLayout, @Nonnull SolarPanelRecipeWrapper recipeWrapper,

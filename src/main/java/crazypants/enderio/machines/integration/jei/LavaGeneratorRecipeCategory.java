...
public class LavaGeneratorRecipeCategory extends
                                         BlankRecipeCategory<LavaGeneratorRecipeCategory.LavaGeneratorRecipeWrapper> {
    ...
    public static class LavaGeneratorRecipeWrapper extends BlankRecipeWrapper {
        ...
        public LavaGeneratorRecipeWrapper(@Nonnull IGuiHelper guiHelper) {
            final IBlockState gen = MachineObject.block_lava_generator.getBlockNN().getDefaultState()
                    .withProperty(EnumRenderMode.RENDER, EnumRenderMode.FRONT_ON);
            final IBlockState chassis = ModObject.block_machine_base.getBlockNN().getDefaultState()
                    .withProperty(EnumRenderPart.SUB, EnumRenderPart.BODY);
            final IBlockState waterfull = Blocks.WATER.getDefaultState()
                    .withProperty(net.minecraft.block.BlockLiquid.LEVEL, 15);
            final IBlockState water = Blocks.WATER.getDefaultState().withProperty(net.minecraft.block.BlockLiquid.LEVEL,
                    13);
            final IBlockState air = Blocks.AIR.getDefaultState();
            this.bsr = new BlockSceneRenderer(
                    new NNList<>(Pair.of(new BlockPos(1, 1, 1), chassis), Pair.of(new BlockPos(1, 1, 1), gen),
                            Pair.of(new BlockPos(1, 0, 1), waterfull), Pair.of(new BlockPos(1, 1, 0), air),
                            Pair.of(new BlockPos(0, 1, 1), water),
        ...
        public void getIngredients(@Nonnull IIngredients ingredients) {
            ...
            ingredients.setOutputs(EnergyIngredient.class, new NNList<>( //
                    new EnergyIngredient(
                            Math.round(
                                    TileLavaGenerator.getNominalPowerGenPerTick(DefaultCapacitorData.BASIC_CAPACITOR)),
                            true), //
                    new EnergyIngredient(
                            Math.round(
                                    TileLavaGenerator.getNominalPowerGenPerTick(DefaultCapacitorData.ENDER_CAPACITOR)),
                            true)));
        }
        ...
        public void drawInfo(@Nonnull Minecraft minecraft, int recipeWidth, int recipeHeight, int mouseX, int mouseY) {
            ...
            int burnTime = (LavaGenConfig.useVanillaBurnTime.get() ? 20000 :
                    TileEntityFurnace.getItemBurnTime(new ItemStack(Items.LAVA_BUCKET))) / Fluid.BUCKET_VOLUME /
                    CapacitorKey.LAVAGEN_POWER_FLUID_USE.get(DefaultCapacitorData.BASIC_CAPACITOR);
    ...
    public static void register() {
        ...
        MachinesPlugin.iModRegistry.addRecipeCategoryCraftingItem(
                new ItemStack(MachineObject.block_lava_generator.getBlockNN()), LavaGeneratorRecipeCategory.UID);
        MachinesPlugin.iModRegistry
                .addRecipes(Collections.singletonList(new LavaGeneratorRecipeWrapper(MachinesPlugin.iGuiHelper)), UID);
    }
    ...
    @Override
    public void setRecipe(@Nonnull IRecipeLayout recipeLayout, @Nonnull LavaGeneratorRecipeWrapper recipeWrapper,

...
public abstract class CrafterRecipeTransferHandler<E extends ContainerCrafter<?>> implements IRecipeTransferHandler<E> {
    ...
    public static void register() {
        ...
        recipeTransferRegistry.addRecipeTransferHandler(new CrafterRecipeTransferHandler.Simple(),
                VanillaRecipeCategoryUid.CRAFTING);
        recipeTransferRegistry.addRecipeTransferHandler(new CrafterRecipeTransferHandler.Normal(),
                VanillaRecipeCategoryUid.CRAFTING);
        MachinesPlugin.iModRegistry.addRecipeClickArea(GuiCrafter.class, 219 - 21, 43, 16, 16,
                VanillaRecipeCategoryUid.CRAFTING);
        MachinesPlugin.iModRegistry.addRecipeCatalyst(new ItemStack(MachineObject.block_crafter.getBlockNN()),
                VanillaRecipeCategoryUid.CRAFTING);
        MachinesPlugin.iModRegistry.addRecipeCatalyst(new ItemStack(MachineObject.block_simple_crafter.getBlockNN()),
                VanillaRecipeCategoryUid.CRAFTING);
    }
    ...
    @Override
    @Nullable
    public IRecipeTransferError transferRecipe(@Nonnull E crafter, @Nonnull IRecipeLayout recipeLayout,

...
public class SagMillRecipeTransferHandler extends BasicRecipeTransferHandler<ContainerSagMill.Normal> {
    ...
    public SagMillRecipeTransferHandler(IModRegistry registry, @Nonnull String uid, int recipeSlotStart,
        ...
        super((StackHelper) registry.getJeiHelpers().getStackHelper(),
                ...
                new BasicRecipeTransferInfo<ContainerSagMill.Normal>(ContainerSagMill.Normal.class, uid,
    ...
    @Override
    @Nullable
    public IRecipeTransferError transferRecipe(@Nonnull ContainerSagMill.Normal container,

...
public class SimpleSagMillRecipeTransferHandler extends BasicRecipeTransferHandler<ContainerSagMill.Simple> {
    ...
    public SimpleSagMillRecipeTransferHandler(IModRegistry registry, @Nonnull String uid, int recipeSlotStart,
                                              int recipeSlotCount, int inventorySlotStart,
                                              int inventorySlotCount) {
        super((StackHelper) registry.getJeiHelpers().getStackHelper(),
                registry.getJeiHelpers().recipeTransferHandlerHelper(),
                new BasicRecipeTransferInfo<ContainerSagMill.Simple>(ContainerSagMill.Simple.class, uid,
                        recipeSlotStart, recipeSlotCount, inventorySlotStart,
                        inventorySlotCount));
    }

    @Override
    @Nullable
    public IRecipeTransferError transferRecipe(@Nonnull ContainerSagMill.Simple container,

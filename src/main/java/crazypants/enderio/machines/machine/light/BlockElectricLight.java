...
public class BlockElectricLight extends BlockEio<TileElectricLight> implements IHaveRenderers {
    ...
    public static final @Nonnull PropertyEnum<EnumFacing> FACING = PropertyEnum.<EnumFacing>create("face",
            EnumFacing.class);
    ...
    public BlockElectricLight(@Nonnull IModObject modObject) {
        super(modObject);
        setLightOpacity(0);
        setDefaultState(getBlockState().getBaseState().withProperty(TYPE, LightType.ELECTRIC)
                .withProperty(ACTIVE, false).withProperty(FACING, EnumFacing.DOWN));
    ...
    @Override
    public @Nonnull IBlockState getActualState(@Nonnull IBlockState state, @Nonnull IBlockAccess world,
                                               @Nonnull BlockPos pos) {
    ...
    @Override
    public AxisAlignedBB getCollisionBoundingBox(@Nonnull IBlockState state, @Nonnull IBlockAccess worldIn,
                                                 @Nonnull BlockPos pos) {
        return null;
    }

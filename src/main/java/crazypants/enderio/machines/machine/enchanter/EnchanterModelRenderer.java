...
public class EnchanterModelRenderer extends ManagedTESR<TileEnchanter> {
    ...
    @Override
    protected void renderTileEntity(@Nonnull TileEnchanter te, @Nonnull IBlockState blockState, float partialTicks,
                                    int destroyStage) {
    ...
    private void renderBase() {
        ...
        IBakedModel bakedModel = modelShapes
                .getModelForState(MachineObject.block_enchanter.getBlockNN().getDefaultState()
                        .withProperty(EnumRenderMode.RENDER, EnumRenderMode.FRONT));

            ...
            for (int i = 0; i < count; i++) {
                ...
                if (rand.nextFloat() > 0.3f) {
                    Particle fx = Minecraft.getMinecraft().effectRenderer.spawnEffectParticle(
                            EnumParticleTypes.SMOKE_NORMAL.getParticleID(), px, y + 0.7, pz, vx, 0, vz,
                            0);
                    if (fx != null) {
                    ...
                    Minecraft.getMinecraft().effectRenderer
                            .addEffect(new ParticleBloodDrip(world, px + front.getXOffset() * 0.1, y + 0.325,
                                    pz + front.getZOffset() * 0.1, front));
                }
            }
        }
    }

...
public class GuiWiredCharger extends GuiInventoryMachineBase<TileWiredCharger> {
    ...
    public static final @Nonnull ResourceLocation baublesBackground = new ResourceLocation("baubles",
    ...
    protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
        ...
        getFontRenderer().drawStringWithShadow(invName,
                sx + (xSize / 2) - (getFontRenderer().getStringWidth(invName) / 2), sy + 4, 0xFFFFFF);
        GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);

...
@Storable
public class TileWiredCharger extends AbstractPowerConsumerEntity
                              implements ILegacyPoweredTile.Receiver, IPaintable.IPaintableTileEntity, IProgressTile {

    protected TileWiredCharger(@Nonnull SlotDefinition slotDefinition, @Nonnull ICapacitorKey maxEnergyRecieved,
    ...
    protected TileWiredCharger(@Nonnull SlotDefinition slotDefinition, @Nonnull ICapacitorKey maxEnergyRecieved,
                               @Nonnull ICapacitorKey maxEnergyStored) {
        this(slotDefinition, maxEnergyRecieved, maxEnergyStored,
    ...
    public static class Simple extends TileWiredCharger {
        ...
        public Simple() {
            super(new SlotDefinition(1, 1, 0), SIMPLE_WIRED_POWER_INTAKE, SIMPLE_WIRED_POWER_BUFFER,
                    SIMPLE_WIRED_POWER_USE);

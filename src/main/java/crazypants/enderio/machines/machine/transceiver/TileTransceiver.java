...
public class TileTransceiver extends AbstractPoweredTaskEntity
                             implements IPaintable.IPaintableTileEntity, IChanneledMachine {
    ...
    private class FluidCap implements IFluidHandler {
        ...
        public IFluidTankProperties[] getTankProperties() {
            ...
            try {
                inGetTankInfo = true;
                return TransceiverRegistry.INSTANCE.getTankInfoForChannels(TileTransceiver.this,
                        getSendChannels(ChannelType.FLUID));
            } finally {
                inGetTankInfo = false;
            }
        }

        ...
        addToolTip(new GuiToolTip(new Rectangle(14, 35, 18, 18), Lang.GUI_TANK_VOID_SLOT.get()) {
            ...
            public boolean shouldDraw() {
                return super.shouldDraw() && getTileEntity().canVoidItems() &&
                        !inventorySlots.getSlot(ContainerTank.trashcan).getHasStack();
            }
        });

        voidBut = new CycleButton<VoidMode.IconHolder>(this, 123, 155, 43 + (showRecipeButton() ? 18 : 0),
                VoidMode.IconHolder.class);
    }

...
public class BlockTank extends AbstractInventoryMachineBlock<TileTank>
                       ...
                       IPaintable.IWrenchHideablePaint, IHaveTESR, ICustomSubItems {
    ...
    protected BlockTank(@Nonnull IModObject modObject) {
        ...
        setLightOpacity(0);
        setDefaultState(
                getBlockState().getBaseState().withProperty(EnumRenderMode.RENDER, EnumRenderMode.AUTO)
    ...
    protected void setBlockStateWrapperCache(@Nonnull IBlockStateWrapper blockStateWrapper, @Nonnull IBlockAccess world,
        ...
        blockStateWrapper.addCacheKey(tileEntity.getFacing())
                .addCacheKey(blockStateWrapper.getValue(EnumTankType.KIND));
    }

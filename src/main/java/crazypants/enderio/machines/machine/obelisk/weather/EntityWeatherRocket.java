...
public class EntityWeatherRocket extends EntityFireworkRocket {
    ...
    private static final @Nonnull DataParameter<Integer> DATA_ID = EntityDataManager
            .<Integer>createKey(EntityWeatherRocket.class, DataSerializers.VARINT);
    ...
    private void doEffect() {
        ...
        world.playSound(this.posX, this.posY, this.posZ, se, SoundCategory.BLOCKS, 20.0F,
        ...
        for (int j = -size; j <= size; ++j) {
            for (int k = -size; k <= size; ++k) {
                for (int l = -size; l <= size; ++l) {
                    ...
                    ParticleFirework.Spark entityfireworksparkfx = new ParticleFirework.Spark(this.world, d1, d2, d3,
                            d4 / d7, d5 / d7, d6 / d7,

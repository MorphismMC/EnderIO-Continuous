...
public class ObeliskBakery {
    ...
    private static final @Nonnull BoundingBox bb1 = BoundingBox.UNIT_CUBE.scale(WIDTH, HEIGHT, 1).translate(0,
            -0.5f + HEIGHT / 2, 0);
    private static final @Nonnull BoundingBox bb2 = BoundingBox.UNIT_CUBE.scale(1, HEIGHT, WIDTH).translate(0,
            -0.5f + HEIGHT / 2, 0);

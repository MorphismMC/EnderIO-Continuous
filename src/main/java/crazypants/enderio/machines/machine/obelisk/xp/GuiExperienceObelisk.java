...
public class GuiExperienceObelisk extends GuiMachineBase<TileExperienceObelisk>
                                  implements ContainerExperienceObeliskProxy {
    ...
    public GuiExperienceObelisk(@Nonnull InventoryPlayer playerInv, @Nonnull TileExperienceObelisk te) {
        ...
        p = new IconButton(this, 800, x, y, IconEIO.SINGLE_PLUS) {
            ...
            public boolean isEnabled() {
                return super.isEnabled() &&
                        XpUtil.getPlayerXPL(Minecraft.getMinecraft().player) >= XpUtil.getExperienceForLevel(1);
            }
        };
        p.setSize(bw, bw);
        p.setIconMargin(2, 2);
        ...
        pp = new IconButton(this, 801, x, y, IconEIO.DOUBLE_PLUS) {
            ...
            public boolean isEnabled() {
                return super.isEnabled() &&
                        XpUtil.getPlayerXPL(Minecraft.getMinecraft().player) >= XpUtil.getExperienceForLevel(10);
            }
        };
        pp.setSize(bw, bw);
        ...
        m = new IconButton(this, 803, x, y, IconEIO.SINGLE_MINUS) {
            ...
            public boolean isEnabled() {
                return super.isEnabled() &&
                        getTileEntity().getContainer().getExperienceTotal() >= XpUtil.getExperienceForLevel(1);
            }
        };
        m.setSize(bw, bw);
        m.setIconMargin(2, 2);
        ...
        mm = new IconButton(this, 804, x, y, IconEIO.DOUBLE_MINUS) {
            ...
            public boolean isEnabled() {
                return super.isEnabled() &&
                        getTileEntity().getContainer().getExperienceTotal() >= XpUtil.getExperienceForLevel(10);
            }
        };
        mm.setSize(bw, bw);
            ...
            protected void updateText() {
                if (getTileEntity().getContainer().getExperienceTotal() <= 0) {
                    ...
                    text.set(2, Lang.GUI_XP_RETR_ALL_3
                            .get(XpUtil.getLevelForExperience(getTileEntity().getContainer().getExperienceTotal() +
                                    XpUtil.getPlayerXPL(Minecraft.getMinecraft().player))));
                }
            }
        });
    }
    ...
    protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
        ...
        int width1 = 110;
        ExperienceBarRenderer.render(this, getGuiLeft() + xSize / 2 - width1 / 2, getGuiTop() + 55, width1,

...
public class ObeliskRenderManager {
    ...
    private static final @Nonnull TextureSupplier[] textures = {
            TextureRegistry.registerTexture("blocks/obelisk_bottom"),
            TextureRegistry.registerTexture("blocks/block_soul_machine_top"),
            TextureRegistry.registerTexture("blocks/block_attractor_side"),
            TextureRegistry.registerTexture("blocks/block_attractor_side"),
            TextureRegistry.registerTexture("blocks/block_attractor_side"),
            TextureRegistry.registerTexture("blocks/block_attractor_side") };
    private static final @Nonnull TextureSupplier[] activeTextures = {
            TextureRegistry.registerTexture("blocks/obelisk_bottom"),
            TextureRegistry.registerTexture("blocks/block_soul_machine_top"),
    ...
    public static void onModelRegister(ModelRegistryEvent event) {
        ...
        if (block != null) {
            ObeliskSpecialRenderer<TileExperienceObelisk> eor = new ObeliskSpecialRenderer<TileExperienceObelisk>(
                    new ItemStack(ModObject.itemXpTransfer.getItemNN()),
                    block);
        ...
        if (block != null) {
            ObeliskSpecialRenderer<TileWeatherObelisk> eor = new WeatherObeliskSpecialRenderer(
        ...
        if (block != null) {
            ObeliskSpecialRenderer<TileInhibitorObelisk> eor = new ObeliskSpecialRenderer<TileInhibitorObelisk>(
                    new ItemStack(Items.ENDER_PEARL), block);

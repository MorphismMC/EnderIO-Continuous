...
public class ObeliskSpecialRenderer<T extends TileEntityBase> extends ManagedTESR<T> {
    ...
    @Override
    protected void renderTileEntity(@Nonnull T te, @Nonnull IBlockState blockState, float partialTicks,
                                    int destroyStage) {
    ...
    protected void renderItemStack(T te, @Nonnull World world, double x, double y, double z, float tick) {
        ...
        if (rei == null) {
            rei = new InnerRenderEntityItem(Minecraft.getMinecraft().getRenderManager(),
    ...
    private static class InnerRenderEntityItem extends RenderEntityItem {
        ...
        @Override
        public void doRender(@Nonnull EntityItem entity, double x, double y, double z, float entityYaw,
                             float partialTicks) {
            ...
            if (bindEntityTexture(entity)) {
                ...
                // of what I assume to be mipmapped textures causes spikes to appear when looking at the edge of a
                // texture.
                // TODO investigate a happy medium here ?
                // this.renderManager.renderEngine.getTexture(this.getEntityTexture(entity)).setBlurMipmap(false,
                // false);
                flag = true;
            }
        ...
        private int func_177077_a(EntityItem itemIn, double p_177077_2_, double p_177077_4_, double p_177077_6_,
            ...
            if (item == null) {
                ...
                float f1 = shouldBob() ?
                        MathHelper.sin((itemIn.getAge() + p_177077_8_) / 10.0F + itemIn.hoverStart) * 0.1F + 0.1F : 0;

...
public abstract class AbstractRangedObeliskEntity extends AbstractPowerConsumerEntity implements IRanged {
    ...
    public AbstractRangedObeliskEntity(@Nonnull SlotDefinition slotDefinition, @Nonnull ICapacitorKey maxEnergyRecieved,
    ...
    /**
     * Checks if this obelisk can work or is missing something. If it returns false, the {@link GuiRangedObelisk} will
     * complain about missing Soul Vials and the
     * obelisk should not consume power.
     * <p>
     * Note: This actually belong on {@link AbstractMobObeliskEntity}, but because the {@link BlockInhibitorObelisk}
     * re-uses the same GUI it is here.
     * 

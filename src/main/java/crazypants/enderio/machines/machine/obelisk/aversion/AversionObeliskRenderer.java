...
public class AversionObeliskRenderer extends ObeliskSpecialRenderer<TileAversionObelisk> {
    ...
    private @Nonnull ItemStack offStack = new ItemStack(blockEndermanSkull.getBlockNN(), 1,
            SkullType.TORMENTED.ordinal());
    private @Nonnull ItemStack onStack = new ItemStack(blockEndermanSkull.getBlockNN(), 1,
            SkullType.REANIMATED_TORMENTED.ordinal());

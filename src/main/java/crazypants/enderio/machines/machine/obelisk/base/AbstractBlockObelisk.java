...
public abstract class AbstractBlockObelisk<T extends AbstractInventoryMachineEntity>
                                          extends AbstractInventoryMachineBlock<T> implements ITESRItemBlock {
    ...
    public void randomDisplayTick(@Nonnull IBlockState bs, @Nonnull World world, @Nonnull BlockPos pos,
        ...
        if (PersonalConfig.machineParticlesEnabled.get() && isActive(world, pos) &&
                shouldDoWorkThisTick(world, pos, 5)) {

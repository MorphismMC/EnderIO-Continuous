...
@Storable
public class TileVat extends AbstractPoweredTaskEntity
    ...
    public static class Enhanced extends TileVat {
        ...
        public Enhanced() {
            super(new SlotDefinition(2, 0, 1), ENHANCED_VAT_POWER_INTAKE, ENHANCED_VAT_POWER_BUFFER,
                    ENHANCED_VAT_POWER_USE);
        }
        ...
        protected boolean shouldDoubleTick(@Nonnull IPoweredTask task, int usedEnergy) {
            double chance = getCapacitorData().getUnscaledValue(ENHANCED_VAT_DOUBLE_OP_CHANCE) *
    ...
    public TileVat(@Nonnull SlotDefinition slotDefinition, @Nonnull ICapacitorKey maxEnergyRecieved,

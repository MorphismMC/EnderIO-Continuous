...
public class TileTelePad extends TileTravelAnchor
    ...
    private boolean clientTeleport(@Nonnull Entity entity) {
        ...
        return !MinecraftForge.EVENT_BUS.post(new TeleportEntityEvent(entity, (ITravelSource) TravelSource.TELEPAD, target.getLocation(), target.getDimension()));
    }

    private boolean serverTeleport(@Nonnull Entity entity) {
        dequeueTeleport(entity, true);
        return TeleportUtil.teleportServer(entity, target.getLocation(), target.getDimension(), false,

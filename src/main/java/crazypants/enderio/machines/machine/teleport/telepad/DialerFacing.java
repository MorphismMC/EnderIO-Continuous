        ...
        switch (getSide()) {
            ...
            default:
                switch (getInputSide()) {
                    ...
                    default:
                        return values()[rotation.rotate(getSide()).ordinal() * 4 +
                                rotation.rotate(getInputSide()).ordinal() % 2];
                }
        }
    }
        ...
        switch (getSide()) {
            ...
            default:
                switch (getInputSide()) {
                    ...
                    default:
                        return values()[mirror.mirror(getSide()).ordinal() * 4 +
                                mirror.mirror(getInputSide()).ordinal() % 2];
                }
        }
    }
}

...
public class GuiAugmentedTravelAccessible extends GuiTravelAccessable<TileTelePad> {
    ...
    public GuiAugmentedTravelAccessible(@Nonnull InventoryPlayer playerInv, @Nonnull TileTelePad te,
                                        @Nonnull World world) {
        ...
        closeWindowButton.setToolTip(Lang.GUI_TELEPAD_TRAVEL_SETTINGS_CLOSE.get(),
                Lang.GUI_TELEPAD_TRAVEL_SETTINGS_CLOSE_2.get());
    }

...
public class GuiCreativeSpawner extends GuiCapMachineBase<TileCreativeSpawner> {
    ...
    protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
        ...
        if (isAdmin()) {
            getFontRenderer().drawStringWithShadow(Lang.GUI_CREATIVE_SPAWNER_SOUL.get(), sx + 26 + 20, sy + 12 + 4,
                    ColorUtil.getRGB(Color.WHITE));
            getFontRenderer().drawStringWithShadow(Lang.GUI_CREATIVE_SPAWNER_TEMPLATE.get(), sx + 26 + 20, sy + 30 + 4,
                    ColorUtil.getRGB(Color.WHITE));
            getFontRenderer().drawStringWithShadow(Lang.GUI_CREATIVE_SPAWNER_OFFERING.get(), sx + 26 + 20, sy + 48 + 4,
                    ColorUtil.getRGB(Color.WHITE));
        } else {
            getFontRenderer().drawStringWithShadow(Lang.GUI_CREATIVE_SPAWNER_OFFERING.get(), sx + 26 + 20, sy + 30 + 4,
                    ColorUtil.getRGB(Color.WHITE));
        }

...
public class ContainerCreativeSpawner extends ContainerEnderCap<EnderInventory, TileCreativeSpawner> {
    ...
    protected void addSlots() {
        ...
        addSlotToContainer(
                new EnderSlot(getItemHandler().getView(Type.INPUT), TileCreativeSpawner.SLOT.PATTERN, 26, 30));
        addSlotToContainer(
                new EnderSlot(getItemHandler().getView(Type.INPUT), TileCreativeSpawner.SLOT.OFFERING, 26, 48));
    }

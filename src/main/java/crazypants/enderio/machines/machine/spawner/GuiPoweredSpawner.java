...
public class GuiPoweredSpawner extends GuiInventoryMachineBase<TilePoweredSpawner>
    ...
    public GuiPoweredSpawner(@Nonnull InventoryPlayer par1InventoryPlayer, @Nonnull TilePoweredSpawner te) {
        super(te, new ContainerPoweredSpawner(par1InventoryPlayer, te), "powered_spawner_spawn",
                "powered_spawner_capture");
    ...
    protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
        ...
        String name = TextFormatting.ITALIC +
                (getTileEntity().getEntity() != null ? getTileEntity().getEntity().getDisplayName() : "");

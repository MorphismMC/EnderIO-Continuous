...
public class BlockNiard extends AbstractCapabilityMachineBlock<TileNiard>
    ...
    @Override
    public @Nullable ContainerNiard<TileNiard> getServerGuiElement(@Nonnull EntityPlayer player, @Nonnull World world,
                                                                   @Nonnull BlockPos pos,
                                                                   @Nullable EnumFacing facing, int param1,
                                                                   @Nonnull TileNiard te) {
        return new ContainerNiard<>(player.inventory, te);
    }

    @Override
    @SideOnly(Side.CLIENT)
    public @Nullable GuiNiard getClientGuiElement(@Nonnull EntityPlayer player, @Nonnull World world,

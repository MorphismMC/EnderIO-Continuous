                    ...
                    try (IResource iresource = resourceManager.getResource(rl)) {
                        ...
                        for (int x = 0; x < size; x++) {
                            for (int y = 0; y < size; y++) {
                                ...
                                final double r = ((color >> 16) & 0xFF) / 255f, g = ((color >> 8) & 0xFF) / 255f,
                        ...
                        Log.warn("Could not load still texture for fluid " + stack +
                                ". Using default color for range display instead.");
                        e.printStackTrace();
                    }
                }

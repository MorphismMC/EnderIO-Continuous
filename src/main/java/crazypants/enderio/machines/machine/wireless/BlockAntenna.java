...
public class BlockAntenna extends BlockEio<TileEntityEio>
                          implements IResourceTooltipProvider, IHaveRenderers, ITEProxy {

    public static final @Nonnull PropertyEnum<EnumFacing> BASE = PropertyEnum.create("base", EnumFacing.class,
            EnumFacing.EAST, EnumFacing.WEST, EnumFacing.DOWN,
    ...
    @Override
    public TileWirelessCharger getParent(@Nonnull IBlockAccess world, @Nonnull BlockPos pos,

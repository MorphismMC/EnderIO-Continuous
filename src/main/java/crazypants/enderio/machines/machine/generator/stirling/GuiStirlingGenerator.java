...
public class GuiStirlingGenerator<T extends TileStirlingGenerator> extends GuiInventoryMachineBase<T> {
    ...
    public GuiStirlingGenerator(@Nonnull InventoryPlayer par1InventoryPlayer, @Nonnull T te) {
        super(te, new ContainerStirlingGenerator<T>(par1InventoryPlayer, te), "stirling_generator",
                "simple_stirling_generator");
        ...
        if (!isSimple) {
            ...
            ttMan.addToolTip(new GuiToolTip(r, Lang.GUI_STIRGEN_SLOT.get(),
                    formatUpgrade(fmt, DefaultCapacitorData.ACTIVATED_CAPACITOR),
    ...
    private static String formatUpgrade(@Nonnull MessageFormat fmt, @Nonnull ICapacitorData upgrade) {
        ...
        Object[] args = new Object[] { upgrade.getLocalizedName(), efficiency, TextFormatting.WHITE,
                TextFormatting.GRAY };

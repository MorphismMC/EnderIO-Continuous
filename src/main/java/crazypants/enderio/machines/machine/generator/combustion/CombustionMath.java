...
public class CombustionMath {
    ...
    public CombustionMath(@Nullable IFluidCoolant coolant, @Nullable IFluidFuel fuel, float capQuality,
                          float machineQuality) {
    ...
    public CombustionMath(@Nullable FluidStack coolantFluid, @Nullable FluidStack fuelFluid, float capQuality,
                          float machineQuality) {

...
public class GuiCrafter extends GuiCapMachineBase<TileCrafter>
                        implements IHaveGhostTargets<GuiCrafter>, ContainerCrafterProxy {
    ...
    public GuiCrafter(@Nonnull InventoryPlayer playerInv, @Nonnull TileCrafter te) {
        ...
        bufferSizeB = new ToggleButton(this, -1, recipeButton.x, recipeButton.y + 19, IconEIO.ITEM_SINGLE,
                IconEIO.ITEM_STACK);
        ...
        powerbar.addTooltip(Op.ADD, What.MIDDLE,
                () -> Lang.GUI_CRAFTER_USERPERCRAFT.get(LangPower.RF(te.getGuiEnergyUse())));
    }

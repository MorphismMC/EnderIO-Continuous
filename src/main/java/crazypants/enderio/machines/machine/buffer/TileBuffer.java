...
@Storable
public abstract class TileBuffer extends AbstractPowerConsumerEntity
                                 implements ILegacyPoweredTile.Receiver, IPaintable.IPaintableTileEntity {
    ...
    public static class TileBufferPower extends TileBuffer {
        ...
        public TileBufferPower() {
            super(new SlotDefinition(0, 0, 1), BufferType.POWER, BUFFER_POWER_INTAKE, BUFFER_POWER_BUFFER,
                    BUFFER_POWER_USE);
        }
    }
    ...
    public static class TileBufferOmni extends TileBuffer {
        ...
        public TileBufferOmni() {
            super(new SlotDefinition(0, 8, 0, 8, 9, 9), BufferType.OMNI, BUFFER_POWER_INTAKE, BUFFER_POWER_BUFFER,
                    BUFFER_POWER_USE);
        }
    }
    ...
    public static class TileBufferCreative extends TileBuffer {
        ...
        public TileBufferCreative() {
            super(new SlotDefinition(9), BufferType.CREATIVE, CREATIVE_BUFFER_POWER_INTAKE,
                    CREATIVE_BUFFER_POWER_BUFFER, CREATIVE_BUFFER_POWER_USE);
        }
    }
    ...
    public int receiveEnergy(EnumFacing from, int maxReceive, boolean simulate) {
        return hasPower() && getIoMode(from).canRecieveInput() ?
                super.receiveEnergy(from, maxReceive, simulate || isCreative()) : 0;
    }

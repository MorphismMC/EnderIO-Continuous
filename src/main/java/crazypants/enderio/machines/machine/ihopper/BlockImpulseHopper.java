...
public class BlockImpulseHopper extends AbstractCapabilityPoweredMachineBlock<TileImpulseHopper>
                                implements ISmartRenderAwareBlock, IResourceTooltipProvider {
    ...
    @SideOnly(Side.CLIENT)
    @Override
    public void randomDisplayTick(@Nonnull IBlockState stateIn, @Nonnull World world, @Nonnull BlockPos pos,
                                  @Nonnull Random rand) {

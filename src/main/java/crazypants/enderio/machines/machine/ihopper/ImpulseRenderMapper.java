...
public class ImpulseRenderMapper implements IRenderMapper.IBlockRenderMapper,
    ...
    @SideOnly(Side.CLIENT)
    protected EnumMap<EnumFacing, EnumIOMode> renderIO(@Nonnull TileImpulseHopper tileEntity,
                                                       @Nonnull BlockImpulseHopper block) {

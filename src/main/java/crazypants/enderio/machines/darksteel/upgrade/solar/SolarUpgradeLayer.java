...
public class SolarUpgradeLayer implements IRenderUpgrade {
    ...
    public void doRenderLayer(@Nonnull RenderPlayer renderPlayer, EntityEquipmentSlot equipmentSlot,
                              ...
                              @Nonnull AbstractClientPlayer entitylivingbaseIn, float p_177141_2_, float p_177141_3_,
                              float partialTicks, float p_177141_5_, float p_177141_6_,
        ...
        Minecraft.getMinecraft().getItemRenderer().renderItem(entitylivingbaseIn, solarUpgrade.getRenderItem(),
                TransformType.HEAD);

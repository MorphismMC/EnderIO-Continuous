...
public interface IFarmer {
     ...
     * 
     * @param trashHandItem
     *                      If true then the main hand item (the one that was set with startUsingItem()) is trashed and
     *                      not returned.
    ...
    /**
     * Adds the given items to the farm's inventory if possible or drops them into the world (at the given location or,
     * if none was given, at the farm's location)
     * otherwise.
     * <p>
     ...
     */
    void registerAction(@Nonnull FarmingAction action, @Nonnull IFarmingTool tool, @Nonnull IBlockState state,
    ...
    /**
     * Determines if the Farming Station is low on saplings. The lower it is, the higher the return value (max 90). If
     * there are more saplings than the reserve
    ...
    /**
     * Adds the given item to the farm's inventory if possible or drops it into the world (at the given location or, if
     * none was given, at the farm's location)
     * otherwise.
     * <p>
     * This is only intended for actions that cannot put them into the result list.
     * 

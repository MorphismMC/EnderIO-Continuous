...
public interface IEnderIOAddon {
    ...
    /**
     * Addons that return their {@link Configuration} object here will be included in the in-game configuration menu of
     * the base mod.
     * <p>
    ...
    /**
     * This allows addons to manually register additional blocks during Ender IO's block registration, i.e. using
     * {@link EnderIO#DOMAIN} for their blocks'
     * registry name.
     * <p>

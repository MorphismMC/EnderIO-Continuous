...
public class BlockInventoryPanelSensor extends AbstractMachineBlock<TileInventoryPanelSensor>
                                       implements IResourceTooltipProvider, IPaintable.ISolidBlockPaintableBlock,
    ...
    @Override
    @Nullable
    public Container getServerGuiElement(@Nonnull EntityPlayer player, @Nonnull World world, @Nullable BlockPos pos,

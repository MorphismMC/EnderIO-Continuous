...
public enum InvpanelObject implements IModObjectBase {
    ...
    blockInventoryChestWarehouse13(BlockInventoryChest::create_enhanced,
            InvpanelTileEntity.TileInventoryChestWarehouse13),
    ...
    private InvpanelObject(@Nullable Function<IModObject, Block> blockMaker,

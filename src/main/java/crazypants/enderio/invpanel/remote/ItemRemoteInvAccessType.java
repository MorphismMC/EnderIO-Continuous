...
public enum ItemRemoteInvAccessType {
    ...
    private ItemRemoteInvAccessType(int index, String nameSuffix, int range, boolean interdimensional,
                                    boolean visible) {
    ...
    public @Nonnull Fluid getFluidType() {
        ...
        if (fluid == null) {
            ...
            fluid = NullHelper.notnull(Fluids.NUTRIENT_DISTILLATION.getFluid(),
                    "Nutrient Distillation registration went AWOL");
        }
        return fluid;
    }

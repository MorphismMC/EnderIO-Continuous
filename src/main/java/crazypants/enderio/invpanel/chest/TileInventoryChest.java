...
@Storable
public abstract class TileInventoryChest extends AbstractCapabilityMachineEntity
                                         implements IPaintable.IPaintableTileEntity, IHasFillLevel {
    ...
    private TileInventoryChest(@Nonnull EnumChestSize size) {
        ...
        getInventory().getSlot(EnergyLogic.CAPSLOT).set(new ItemStack(ModObject.itemBasicCapacitor.getItemNN(), 1,
                DefaultCapacitorData.BASIC_CAPACITOR.ordinal()));

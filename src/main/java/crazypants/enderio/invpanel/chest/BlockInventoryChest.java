...
public class BlockInventoryChest extends AbstractMachineBlock<TileInventoryChest>
                                 implements IResourceTooltipProvider, ISmartRenderAwareBlock,
    ...
    @Override
    public int getComparatorInputOverride(@Nonnull IBlockState blockStateIn, @Nonnull World worldIn,
                                          @Nonnull BlockPos pos) {

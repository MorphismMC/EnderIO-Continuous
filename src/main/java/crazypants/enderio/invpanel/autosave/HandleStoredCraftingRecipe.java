...
public class HandleStoredCraftingRecipe implements IHandler<StoredCraftingRecipe> {
    ...
    public boolean store(@Nonnull Registry registry, @Nonnull Set<NBTAction> phase, @Nonnull NBTTagCompound nbt,
                         ...
                         @Nonnull StoredCraftingRecipe object) throws IllegalArgumentException, IllegalAccessException,
    ...
    @Override
    public StoredCraftingRecipe read(@Nonnull Registry registry, @Nonnull Set<NBTAction> phase,

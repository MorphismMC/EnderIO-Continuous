...
public class ThingsValue extends AbstractValue<Things> {
    ...
    protected ThingsValue(@Nonnull IValueFactory owner, @Nonnull String section, @Nonnull String keyname,
                          @Nonnull Things defaultValue, @Nonnull String text) {
    ...
    public static final @Nonnull IByteBufAdapter<Things> THINGS = ByteBufAdapters
            .register(new IByteBufAdapter<Things>() {

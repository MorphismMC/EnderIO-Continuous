...
public final class RecipeConfig {
    ...
    public static final IValue<Float> energyFactorForReinforcedObsidian = FP
            .make("energyFactorForReinforcedObsidian", 10f, //
                    "Painting Reinforced Obsidian costs this much in relation to 'energyPerTask'.")
            .setRange(.001, 1000).sync();

    public static final IValue<Float> energyFactorForWorkbench = FP.make("energyFactorForWorkbench", 50f, //
            "Painting a workbench (crafting table) costs this in relation to than 'energyPerTask'.").setRange(1, 1000)
            .sync();

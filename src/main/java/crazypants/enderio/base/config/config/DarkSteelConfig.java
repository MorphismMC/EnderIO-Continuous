...
public final class DarkSteelConfig {
    ...
    public static final NNList<IValue<Integer>> miningLevel = new NNList<>( //
            F_MATS_DS.make("miningLevel", 4, //
                    "Mining level for tools made out of Dark Steel. (highest vanilla level is 3, highest TiC level is 4 by default)")
                    .setMin(0).sync(),
            F_MATS_ES.make("miningLevel", 5, //
                    "Mining level for tools made out of End Steel. (highest vanilla level is 3, highest TiC level is 4 by default)")
                    .setMin(0).sync(),
            F_MATS_ST.make("miningLevel", 8, //
                    "Mining level for tools made out of Stellar Alloy. (highest vanilla level is 3, highest TiC level is 4 by default)")
                    .setMin(0).sync());
    ...
    public static final IValue<Float> pickApplyObsidianEfficiencyAtHardness = F_PICKAXE.make(
            "obsidianEfficiencyAtHardness", 40f, //
            "If set to a value > 0, the obsidian speed and power use will be used for all blocks with hardness >= to this value.")
            .setRange(1, 10000).sync();
    ...
    public static final IValue<Integer> axePowerUsePerDamagePoint = F_AXE.make("powerUsePerDamagePoint", 750, //
            "Energy use per damage/durability point avoided.").setRange(0, 99999999).sync();
    public static final IValue<Integer> axePowerUsePerDamagePointMultiHarvest = F_AXE
            .make("powerUsePerDamagePointMultiHarvest", 1500, //
                    "Energy per damage/durability point avoided when shift-harvesting multiple logs")
            .setRange(0, 99999999).sync();
    ...
    public static final IValue<Integer> crookEnergyPerDamageMulti = F_CROOK.make("energyPerDamageMulti", 150, //
            "Energy per damage/durability point avoided when shift-harvesting multiple blocks.").setRange(1, 99999999)
            .sync();
    ...
    public static final IValue<Double> darkSteelSwordEnderPearlDropChance = F_SWORD.make("enderPearlDropChance", 1.05, //
            "The chance that an ender pearl will be dropped when using the sword (0 = no chance, 1 = 100% chance; can go over 100%).")
            .setRange(0, 10).sync();
    public static final IValue<Double> darkSteelSwordEnderPearlDropChancePerLooting = F_SWORD.make(
            "enderPearlDropChancePerLooting", 0.5, //
    ...
    public static final IValue<Integer> darkSteelHoeCost = F_HOE.make("darkSteelHoeCost", 4,
            "Number of levels required for the 'Hoe' upgrade.");
    ...
    public static final IValue<Float> darkSteelSpeedBonusEmpowered = F_SPEED.make("empoweredBonus1", 1f, //
            "The extra effectiveness of the speed upgrade when the Leggings are empowered I and have energy.")
            .setRange(0, 5).sync();
    public static final IValue<Float> darkSteelSpeedBonusEmpowered1 = F_SPEED.make("empoweredBonus2", 1.10f, //
            "The extra effectiveness of the speed upgrade when the Leggings are empowered II and have energy.")
            .setRange(0, 5).sync();
    public static final IValue<Float> darkSteelSpeedBonusEmpowered2 = F_SPEED.make("empoweredBonus3", 1.50f, //
            "The extra effectiveness of the speed upgrade when the Leggings are empowered III and have energy.")
            .setRange(0, 5).sync();
    public static final IValue<Float> darkSteelSpeedBonusEmpowered3 = F_SPEED.make("empoweredBonus4", 2.00f, //
            "The extra effectiveness of the speed upgrade when the Leggings are empowered IV and have energy.")
            .setRange(0, 5).sync();
    public static final IValue<Float> darkSteelSpeedBonusEmpowered4 = F_SPEED.make("empoweredBonus5", 2.50f, //
            "The extra effectiveness of the speed upgrade when the Leggings are empowered V and have energy.")
            .setRange(0, 5).sync();

    public static final NNList<IValue<Integer>> speedUpgradeCost = new NNList<>( //
            F_SPEED.make("upgradeCost1", 4, "Number of levels required for the 'Speed I' upgrade.").setRange(1, 99)
                    .sync(), //
            F_SPEED.make("upgradeCost2", 6, "Number of levels required for the 'Speed II' upgrade.").setRange(1, 99)
                    .sync(), //
            F_SPEED.make("upgradeCost3", 8, "Number of levels required for the 'Speed III' upgrade.").setRange(1, 99)
                    .sync());
    ...
    public static final NNList<IValue<Integer>> jumpUpgradeCost = new NNList<>( //
            F_JUMP.make("upgradeCost1", 4, "Number of levels required for the 'Jump I' upgrade.").setRange(1, 99)
                    .sync(), //
            F_JUMP.make("upgradeCost2", 6, "Number of levels required for the 'Jump II' upgrade.").setRange(1, 99)
                    .sync(), //
            F_JUMP.make("upgradeCost3", 8, "Number of levels required for the 'Jump III' upgrade.").setRange(1, 99)
                    .sync());
    ...
    public static final NNList<IValue<Integer>> anvilUpgradeCost = new NNList<>( //
            F_ANVIL.make("upgradeCost1", 1, "Number of levels required for the 'Anvil I' upgrade.").setRange(1, 99)
                    .sync(), //
            F_ANVIL.make("upgradeCost2", 2, "Number of levels required for the 'Anvil II' upgrade.").setRange(1, 99)
                    .sync(), //
            F_ANVIL.make("upgradeCost3", 4, "Number of levels required for the 'Anvil III' upgrade.").setRange(1, 99)
                    .sync());
    ...
    public static final NNList<IValue<Integer>> inventoryUpgradeCost = new NNList<>( //
            ...
            F_INVENTORY.make("upgradeCost3", 32, "Cost for the inventory III upgrade in levels.").setRange(1, 99)
                    .sync());
    ...
    public static final NNList<IValue<COLS>> inventoryUpgradeCols = new NNList<>( //
            F_INVENTORY.make("columnsFeet", COLS.COL3,
                    "Number of inventory columns the inventory upgrade gives for foot armor.").sync(),
            F_INVENTORY.make("columnsLegs", COLS.COL5,
                    "Number of inventory columns the inventory upgrade gives for leg armor.").sync(),
            F_INVENTORY.make("columnsBody", COLS.COL9,
                    "Number of inventory columns the inventory upgrade gives for body armor.").sync(),
            F_INVENTORY.make("columnsHead", COLS.COL1,
                    "Number of inventory columns the inventory upgrade gives for head armor.").sync());

    public static final NNList<IValue<Integer>> inventoryUpgradeRows = new NNList<>( //
            F_INVENTORY.make("rows1", 2, "Number of inventory columns the inventory I upgrade gives.").setRange(1, 6)
                    .sync(),
            F_INVENTORY.make("rows2", 4, "Number of inventory columns the inventory II upgrade gives.").setRange(1, 6)
                    .sync(),
            F_INVENTORY.make("rows3", 6, "Number of inventory columns the inventory III upgrade gives.").setRange(1, 6)
                    .sync());
    ...
    public static final NNList<IValue<Integer>> explosiveUpgradeCost = new NNList<>( //
            ...
            F_EXPLOSIVE.make("upgradeCost3", 18, "Cost for the explosive III upgrade in levels.").setRange(1, 99)
                    .sync(),
    ...
    public static final IValue<Integer> explosiveUpgradeEnergyPerBlock = F_EXPLOSIVE.make("energyPerBlock", 20, //
            "Extra energy the explosive upgrade uses to blow up blocks. This goes on top of the energy used to counteract durability loss.")
            .setMin(0).sync();

    public static final IValue<Float> explosiveUpgradeDurabilityChance = F_EXPLOSIVE.make("durabilityChance", .3f, //
            "Chance that employing the explosive upgrade to blow up extra blocks costs the pickaxe durability.")
            .setRange(0, 1).sync();

    public static final IValue<ExplosiveTargets> explosiveUpgradeTargets = F_EXPLOSIVE.make("targets",
            ExplosiveTargets.DEFAULT, //
    ...
    public static final IValue<Things> explosiveUpgradeCustomDirt = F_EXPLOSIVE.make("customDirt", new Things(), //
            "Custom 'dirt' target blocks for the explosive upgrade. See 'targets'. (Used whith the 'spoon' upgrade.)")
            .sync();
    ...
    public static final IValue<Integer> swimCost = F_SWIM
            .make("upgradeCost", 4, "Number of levels required for the 'Swim' upgrade.").setRange(1, 99).sync();
    ...
    public static final IValue<Double> swimSpeedDepthStrider = F_SWIM.make("speedDepthStrider", 2.5 / 50, //
            "Speed modifier applied when swimming with the Dark Steel Boots with Flippers enchanted with Depth Strider.")
            .setRange(0.1 / 50, 10).sync();

    public static final IValueFactory F_NIGHT_VISION = F_UPGRADES.section(".nightVision");

    public static final IValue<Integer> nightVisionCost = F_NIGHT_VISION
            .make("upgradeCost", 4, "Number of levels required for the 'Night Vision' upgrade.")
            .setRange(1, 99).sync();
    ...
    public static final IValue<Double> cutoffDistance = F_PADDING.make("cutoffDistance", 15d, //
            "Distance in blocks that is no longer considered 'nearby' by the 'Padding' upgrade. Sounds at least this far away will play normally.")
            .setRange(1, 99);
    public static final IValue<Float> pitchAdjust = F_PADDING.make("pitchAdjust", .8f, //
            "All sounds will be adjusted in pitch by this factor when using the 'Padding' upgrade. (1 for off")
            .setRange(0.01, 1);
    ...
    public static final NNList<IValue<Integer>> darkBowDrawSpeed = new NNList<>( //
            F_DBOW.make("drawSpeedUnpowered", 30,
                    "Draw speed of the Dark Steel Bow when not empowered or out of energy. (normal bow is 20)")
                    .setRange(1, 100).sync(), //
            F_DBOW.make("drawSpeed1", 20,
                    "Draw speed of the Dark Steel Bow when 'Empowered I' and it has energy. (normal bow is 20)")
                    .setRange(1, 100).sync(), //
            F_DBOW.make("drawSpeed2", 18,
                    "Draw speed of the Dark Steel Bow when 'Empowered II' and it has energy. (normal bow is 20)")
                    .setRange(1, 100).sync(), //
            F_DBOW.make("drawSpeed3", 16,
                    "Draw speed of the Dark Steel Bow when 'Empowered III' and it has energy. (normal bow is 20)")
                    .setRange(1, 100).sync(), //
            F_DBOW.make("drawSpeed4", 14,
                    "Draw speed of the Dark Steel Bow when 'Empowered IV' and it has energy. (normal bow is 20)")
                    .setRange(1, 100).sync(), //
            F_DBOW.make("drawSpeed5", 12,
                    "Draw speed of the Dark Steel Bow when 'Empowered V' and it has energy. (normal bow is 20)")
                    .setRange(1, 100).sync());

    public static final NNList<IValue<Float>> darkBowForceMultipliers = new NNList<>( //
            F_DBOW.make("forceUnpowered", 1.1f,
                    "Force multiplier of the Dark Steel Bow when not empowered or out of energy.").setRange(1, 10)
                    .sync(), //
            F_DBOW.make("force1", 1.2f, "Force multiplier of the Dark Steel Bow when 'Empowered I' and it has energy.")
                    .setRange(1, 10).sync(), //
            F_DBOW.make("force2", 1.3f, "Force multiplier of the Dark Steel Bow when 'Empowered II' and it has energy.")
                    .setRange(1, 10).sync(), //
            F_DBOW.make("force3", 1.4f,
                    "Force multiplier of the Dark Steel Bow when 'Empowered III' and it has energy.").setRange(1, 10)
                    .sync(), //
            F_DBOW.make("force4", 1.5f, "Force multiplier of the Dark Steel Bow when 'Empowered IV' and it has energy.")
                    .setRange(1, 10).sync(), //
            F_DBOW.make("force5", 1.6f, "Force multiplier of the Dark Steel Bow when 'Empowered V' and it has energy.")
                    .setRange(1, 10).sync());

    public static final NNList<IValue<Float>> darkBowFOVMultipliers = new NNList<>( //
            F_DBOW.make("fovUnpowered", .25f,
                    "FOV multiplier of the Dark Steel Bow when not empowered or out of energy.").setRange(0, 1).sync(), //
            F_DBOW.make("fov1", .3f, "FOV multiplier of the Dark Steel Bow when 'Empowered I' and it has energy.")
                    .setRange(0, 1).sync(), //
            F_DBOW.make("fov2", .35f, "FOV multiplier of the Dark Steel Bow when 'Empowered II' and it has energy.")
                    .setRange(0, 1).sync(), //
            F_DBOW.make("fov3", .4f, "FOV multiplier of the Dark Steel Bow when 'Empowered III' and it has energy.")
                    .setRange(0, 1).sync(), //
            F_DBOW.make("fov4", .45f, "FOV multiplier of the Dark Steel Bow when 'Empowered IV' and it has energy.")
                    .setRange(0, 1).sync(), //
            F_DBOW.make("fov5", .5f, "FOV multiplier of the Dark Steel Bow when 'Empowered V' and it has energy.")
                    .setRange(0, 1).sync());

    public static final NNList<IValue<Double>> darkBowDamageBonus = new NNList<>( //
            F_DBOW.make("damageUnpowered", 0.0,
                    "Damage bonus of the Dark Steel Bow when not empowered or out of energy.").setRange(0, 30).sync(), //
            F_DBOW.make("damage1", 0.0, "Damage bonus of the Dark Steel Bow when 'Empowered I' and it has energy.")
                    .setRange(0, 30).sync(), //
            F_DBOW.make("damage2", 0.0, "Damage bonus of the Dark Steel Bow when 'Empowered II' and it has energy.")
                    .setRange(0, 30).sync(), //
            F_DBOW.make("damage3", 0.0, "Damage bonus of the Dark Steel Bow when 'Empowered III' and it has energy.")
                    .setRange(0, 30).sync(), //
            F_DBOW.make("damage4", 0.0, "Damage bonus of the Dark Steel Bow when 'Empowered IV' and it has energy.")
                    .setRange(0, 30).sync(), //
            F_DBOW.make("damage5", 0.0, "Damage bonus of the Dark Steel Bow when 'Empowered V' and it has energy.")
                    .setRange(0, 30).sync());
    ...
    public static final NNList<IValue<Integer>> endBowDrawSpeed = new NNList<>( //
            F_EBOW.make("drawSpeedUnpowered", 20,
                    "Draw speed of the End Steel Bow when not empowered or out of energy. (normal bow is 20)")
                    .setRange(1, 100).sync(), //
            F_EBOW.make("drawSpeed1", 15,
                    "Draw speed of the End Steel Bow when 'Empowered I' and it has energy. (normal bow is 20)")
                    .setRange(1, 100).sync(), //
            F_EBOW.make("drawSpeed2", 12,
                    "Draw speed of the End Steel Bow when 'Empowered II' and it has energy. (normal bow is 20)")
                    .setRange(1, 100).sync(), //
            F_EBOW.make("drawSpeed3", 11,
                    "Draw speed of the End Steel Bow when 'Empowered III' and it has energy. (normal bow is 20)")
                    .setRange(1, 100).sync(), //
            F_EBOW.make("drawSpeed4", 10,
                    "Draw speed of the End Steel Bow when 'Empowered IV' and it has energy. (normal bow is 20)")
                    .setRange(1, 100).sync(), //
            F_EBOW.make("drawSpeed5", 9,
                    "Draw speed of the End Steel Bow when 'Empowered V' and it has energy. (normal bow is 20)")
                    .setRange(1, 100).sync());

    public static final NNList<IValue<Float>> endBowForceMultipliers = new NNList<>( //
            F_EBOW.make("forceUnpowered", 1.25f,
                    "Force multiplier of the End Steel Bow when not empowered or out of energy.").setRange(1, 10)
                    .sync(), //
            F_EBOW.make("force1", 1.35f, "Force multiplier of the End Steel Bow when 'Empowered I' and it has energy.")
                    .setRange(1, 10).sync(), //
            F_EBOW.make("force2", 1.45f, "Force multiplier of the End Steel Bow when 'Empowered II' and it has energy.")
                    .setRange(1, 10).sync(), //
            F_EBOW.make("force3", 1.55f,
                    "Force multiplier of the End Steel Bow when 'Empowered III' and it has energy.").setRange(1, 10)
                    .sync(), //
            F_EBOW.make("force4", 1.65f, "Force multiplier of the End Steel Bow when 'Empowered IV' and it has energy.")
                    .setRange(1, 10).sync(), //
            F_EBOW.make("force5", 1.75f, "Force multiplier of the End Steel Bow when 'Empowered V' and it has energy.")
                    .setRange(1, 10).sync());

    public static final NNList<IValue<Float>> endBowFOVMultipliers = new NNList<>( //
            F_EBOW.make("fovUnpowered", .3f, "FOV multiplier of the End Steel Bow when not empowered or out of energy.")
                    .setRange(0, 1).sync(), //
            F_EBOW.make("fov1", .35f, "FOV multiplier of the End Steel Bow when 'Empowered I' and it has energy.")
                    .setRange(0, 1).sync(), //
            F_EBOW.make("fov2", .4f, "FOV multiplier of the End Steel Bow when 'Empowered II' and it has energy.")
                    .setRange(0, 1).sync(), //
            F_EBOW.make("fov3", .45f, "FOV multiplier of the End Steel Bow when 'Empowered III' and it has energy.")
                    .setRange(0, 1).sync(), //
            F_EBOW.make("fov4", .5f, "FOV multiplier of the End Steel Bow when 'Empowered IV' and it has energy.")
                    .setRange(0, 1).sync(), //
            F_EBOW.make("fov5", .55f, "FOV multiplier of the End Steel Bow when 'Empowered V' and it has energy.")
                    .setRange(0, 1).sync());

    public static final NNList<IValue<Double>> endBowDamageBonus = new NNList<>( //
            F_EBOW.make("damageUnpowered", 0.0,
                    "Damage bonus of the End Steel Bow when not empowered or out of energy.").setRange(0, 30).sync(), //
            F_EBOW.make("damage1", 0.0, "Damage bonus of the End Steel Bow when 'Empowered I' and it has energy.")
                    .setRange(0, 30).sync(), //
            F_EBOW.make("damage2", 0.0, "Damage bonus of the End Steel Bow when 'Empowered II' and it has energy.")
                    .setRange(0, 30).sync(), //
            F_EBOW.make("damage3", 0.0, "Damage bonus of the End Steel Bow when 'Empowered III' and it has energy.")
                    .setRange(0, 30).sync(), //
            F_EBOW.make("damage4", 0.0, "Damage bonus of the End Steel Bow when 'Empowered IV' and it has energy.")
                    .setRange(0, 30).sync(), //
            F_EBOW.make("damage5", 0.0, "Damage bonus of the End Steel Bow when 'Empowered V' and it has energy.")
                    .setRange(0, 30).sync());

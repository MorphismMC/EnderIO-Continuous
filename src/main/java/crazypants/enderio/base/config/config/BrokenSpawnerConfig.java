...
public final class BrokenSpawnerConfig {
    ...
    public static final IValue<Double> brokenSpawnerDropChance = F.make("brokenSpawnerDropChance", 1.0, //
            ...
            .setRange(0.0, 1.0).sync();

    public static final IValue<Things> brokenSpawnerToolBlacklist = F
            .make("brokenSpawnerToolBlacklist", new Things("item:rotarycraft:rotarycraft_item_bedpick"), //

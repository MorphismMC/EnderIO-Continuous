...
public final class DiagnosticsConfig {
    ...
    public static final IValue<Boolean> debugUpgradeDebugMessagesToInfo = F.make("debugUpgradeDebugMessagesToInfo",
            false, GENERIC_WARNING);

    public static final IValue<Boolean> debugTraceNBTActivityExtremelyDetailed = F
            .make("debugTraceNBTActivityExtremelyDetailed", false, GENERIC_WARNING);

    public static final IValue<Boolean> debugTraceTELivecycleExtremelyDetailed = F
            .make("debugTraceTELivecycleExtremelyDetailed", false, GENERIC_WARNING);

    public static final IValue<Boolean> debugTraceCapLimitsExtremelyDetailed = F
            .make("debugTraceCapLimitsExtremelyDetailed", false, GENERIC_WARNING);

    public static final IValue<Boolean> debugProfilerTracer = F.make("debugProfilerTracer", false, GENERIC_WARNING);

    public static final IValue<Boolean> debugProfilerAntiNuclearActivist = F.make("debugProfilerAntiNuclearActivist",
            true, //
    ...
    public static final IValue<Protection> protectEnergyOverflow = F.make("protectAgainstEnergyOverflow",
            Protection.SOFT, //

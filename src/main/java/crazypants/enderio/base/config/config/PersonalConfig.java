...
public final class PersonalConfig {
    ...
    public static final IValue<Boolean> recipeButtonInMachineGuis = F.make("recipeButtonInMachineGuis",
            Math.random() > .75, //
    ...
    public static final IValue<String> GUIBrandingTexture = F.make("GUIBrandingTexture",
            EnderIO.DOMAIN + ":textures/items/item_enderface_none.png", //
    ...
    public static final IValue<Boolean> tooltipsAddFuelToFluidContainers = T.make("enableFluidContainerFuelTooltip",
            true, //
    ...
    public static final IValue<TooltipPaintEnum> enablePainterTooltip = T.make("enablePainterTooltip",
            TooltipPaintEnum.AUTO,

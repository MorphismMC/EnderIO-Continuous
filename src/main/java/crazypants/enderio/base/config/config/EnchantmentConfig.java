...
public final class EnchantmentConfig {
    ...
    public static final IValue<Boolean> repellentEnabled = F_REP.make("enabled", true, //
            "Should Repellent be acquirable? If disabled, it will still work but it will not be possible to apply it to items.")
            .sync();
    ...
    public static final IValue<Float> repellentSafeMobsChance = F_REP.make("safeMobsChanc", .75f, //
            "Probability that non-players will be teleported to a safe target location. (Player always will be teleported safely.)")
            .setRange(0, 1).sync();
    ...
    public static final IValue<Boolean> shimmerEnabled = F_SIM.make("enabled", true, //
            "Should Shimmer be acquirable? If disabled, it will still work but it will not be possible to apply it to items.")
            .sync();
    ...
    public static final IValue<Boolean> witherArrowEnabled = F_WIA.make("enabled", true, //
            "Should WitherArrow (Withering) be acquirable? If disabled, it will still work but it will not be possible to apply it to items.")
            .sync();
    ...
    public static final IValue<Boolean> witherWeaponEnabled = F_WIW.make("enabled", true, //
            "Should WitherWeapon (Decay) be acquirable? If disabled, it will still work but it will not be possible to apply it to items.")
            .sync();
    ...
    public static final IValue<Boolean> soulboundEnabled = F_SOB.make("enabled", true, //
            "Should Soulbound be acquirable? If disabled, it will still work but it will not be possible to apply it to items.")
            .sync();

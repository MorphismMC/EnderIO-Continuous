...
public final class TeleportConfig {
    ...
    public static final IValue<Float> costItem2Block = F.make("defaultTeleportEnergyCostItemToBlock", 250f, //
            ...
            .setRange(0, 999999).sync();

    public static final IValue<Float> costItem2Blink = F.make("defaultTeleportEnergyCostItem", 250f, //
            "Default energy cost per block of distance of travel using an item (e.g. Staff blinking).")
            .setRange(0, 999999).sync();
    ...
    public static final IValue<Boolean> enableBlinkUnbreakableBlocks = BLINK
            .make("enableBlinkThroughUnbreakableBlocks", false, //
                    "Allow blinking through unbreakable (e.g. bedrock) blocks?")
            .sync();

    public static final IValue<Things> blockBlacklist = BLINK
            .make("blockBlacklist", new Things("Thaumcraft:blockWarded"), //
                    "Blocks that cannot be blinked through.")
            .sync();

...
public final class BlockConfig {
    ...
    public static final IValue<Integer> confusingChargeEffectDuration = F11.make("duration", 300, //
            "Numer of ticks the confusion effect active. Scales with distance from the expolosion.").setRange(1, 3000)
            .sync();
    ...
    public static final IValue<Float> darkSteelLadderSpeedBoost = F.make("darkSteelLadderSpeedBoost", 0.06f, //
            "Speed boost, in blocks per tick, that the DS ladder gives over the vanilla ladder.").setRange(0, 0.6)
            .sync();

    public static final IValueFactoryEIO GLASS = F.section(".glass");

    public static final IValue<Boolean> clearGlassConnectToFusedQuartz = GLASS.make("clearGlassConnectToFusedQuartz",
            false, //
    ...
    public static final IValue<Boolean> glassConnectToTheirColorVariants = GLASS.make(
    ...
    public static final IValue<Boolean> paintedGlowstoneRequireSilkTouch = GLASS
            .make("paintedGlowstoneRequireSilkTouch", false, //
    ...
    public static final IValue<Float> darkSteelAnvilDamageChance = DSA.make("damageChance", 0.024f, //
            "Chance that the Dark Steel Anvil will take damage after repairing something. (Vanilla anvil is 0.12)")
            .setRange(0, 1).sync();

    public static final IValue<Integer> dsaMaxCost = DSA.make("maxCost", 80, //
            "Maximum enchantment cost the Dark Steel Anvil can handle. Also applies to the Anvil Upgrade.")
            .setRange(40, 400).sync();
    ...
    public static final IValue<Float> dsaMinDrop = DSA.make("minDrop", 0.25f, //
            "Minimum amount of materials that will drop when recycling a broken Dark Steel Anvil. (0 = nothing, 1 = everything)")
            .setRange(0, 1).sync();

    public static final IValue<Float> dsaMaxDrop = DSA.make("maxDrop", 1f, //
            "Maximum amount of materials that will drop when recycling a broken Dark Steel Anvil. (0 = nothing, 1 = everything)")
            .setRange(0, 1).sync();

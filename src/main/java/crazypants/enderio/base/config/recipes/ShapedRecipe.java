...
public class ShapedRecipe extends ShapedRecipes {
    ...
    public ShapedRecipe(@Nonnull ResourceLocation name, int width, int height, @Nonnull NNList<Ingredient> ingredients,
                        @Nonnull Things result) {
    ...
    public static class Upgrade extends ShapedRecipe {
        ...
        public Upgrade(@Nonnull ResourceLocation name, int width, int height, @Nonnull NNList<Ingredient> ingredients,
                       @Nonnull Things result) {
        ...
        public @Nonnull ItemStack getCraftingResult(@Nonnull InventoryCrafting inv) {
            ...
            // Pass 2: Different item, both ours (better not define upgrade recipes that take 2 of our items that have
            // nbt...)

...
public interface IRecipeConfigElement {
    ...
    boolean setAttribute(@Nonnull StaxFactory factory, @Nonnull String name,
                         @Nonnull String value) throws InvalidRecipeConfigException, XMLStreamException;
    ...
    /**
     * Helper method to convert a String to an Optional. <code>null</code>, the empty String and Strings only containing
     * whitespace will be mapped top empty.

...
public class ShapelessRecipe extends ShapelessRecipes {
    ...
    public ShapelessRecipe(@Nonnull ResourceLocation name, @Nonnull NNList<Ingredient> ingredients,
    ...
    public static class Upgrade extends ShapelessRecipe {
        ...
        public Upgrade(@Nonnull ResourceLocation name, @Nonnull NNList<Ingredient> ingredients,
                       @Nonnull Things result) {

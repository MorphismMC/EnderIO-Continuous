...
public class Serializer {
    ...
    static <T> void addListOptional(JsonObject jsonobject, String name, Iterable<T> list,
    ...
    static <T> void addOptional(JsonObject jsonobject, String name, Optional<T> value,
                                JsonSerializationContext context) {
        if (value.isPresent()) {
    ...
    public static class ConditionConfigSerializer implements JsonSerializer<ConditionConfig> {
        ...
        @Override
        public JsonObject serialize(@Nullable ConditionConfig src, @Nullable Type typeOfSrc,
    ...
    public static class ConditionDependencySerializer implements JsonSerializer<ConditionDependency> {
        ...
        @Override
        public JsonObject serialize(@Nullable ConditionDependency src, @Nullable Type typeOfSrc,
                                    @Nullable JsonSerializationContext context) {
            JsonObject jsonobject = new JsonObject();
    ...
    public static abstract class AbstractConditionalSerializer<A extends AbstractConditional>
        ...
        @Override
        public JsonObject serialize(@Nullable A src, @Nullable Type typeOfSrc,
                                    @Nullable JsonSerializationContext context) {
            JsonObject jsonobject = new JsonObject();
    ...
    public static class AliasSerializer extends AbstractConditionalSerializer<Alias> {
        ...
        @Override
        public JsonObject serialize(@Nullable Alias src, @Nullable Type typeOfSrc,
                                    @Nullable JsonSerializationContext context) {
    ...
    public static class AliasesSerializer implements JsonSerializer<Aliases> {
        ...
        @Override
        public JsonArray serialize(@Nullable Aliases src, @Nullable Type typeOfSrc,
                                   @Nullable JsonSerializationContext context) {
            JsonArray jsonArray = new JsonArray();

...
public interface IExternalConnectionContainer {
     ...
     */
    void setInOutSlotsVisible(boolean filtersVisible, boolean upgradesVisible, @Nonnull Conduit conduit);
     ...
     */
    void createGhostSlots(@Nonnull NNList<GhostSlot> ghostSlots, @Nonnull NNList<ItemStack> filtersIn,
     ...
     *                   The ItemStacks of the upgrades for the ghost slot
     */
    void createGhostSlots(@Nonnull NNList<GhostSlot> ghostSlots, @Nonnull NNList<ItemStack> filters,
                          @Nonnull NNList<ItemStack> upgrades);

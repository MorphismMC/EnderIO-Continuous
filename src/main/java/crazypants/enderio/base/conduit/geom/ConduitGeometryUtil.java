...
public final class ConduitGeometryUtil {
    ...
    private @Nonnull BoundingBox[] createExternalConnector(@Nonnull EnumFacing dir, float connectorDepth,
    ...
    private @Nonnull BoundingBox createConnectorComponent(@Nonnull EnumFacing dir, float cornerMin, float cornerMax,
    ...
    private final @Nonnull EnumMap<EnumFacing, List<Vertex>> IO_RING_VERTS = new EnumMap<EnumFacing, List<Vertex>>(
            EnumFacing.class);
    ...
    public void addModeConnectorQuads(EnumFacing dir, @Nonnull Offset offset, @Nonnull TextureAtlasSprite tex,
                                      Vector4f color, @Nonnull List<BakedQuad> quads) {

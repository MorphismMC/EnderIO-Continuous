...
public class ConnectivityTool {
    ...
    private static final @Nonnull Things CONNECTABLES = new Things().add(Blocks.REDSTONE_LAMP)
            ...
            .add(Blocks.BIRCH_DOOR).add(Blocks.DARK_OAK_DOOR).add(Blocks.IRON_DOOR).add(Blocks.JUNGLE_DOOR)
            .add(Blocks.OAK_DOOR).add(Blocks.SPRUCE_DOOR)
    ...
    public static boolean shouldAutoConnectRedstone(@Nonnull World world, @Nonnull IBlockState state,
                                                    @Nonnull BlockPos pos, @Nonnull EnumFacing from) {

...
public class ConduitRegistry {
    ...
    public static void register(ConduitTypeDefinition info) {
        ...
        Offset none = info.getPreferedOffsetForNone(), x = info.getPreferedOffsetForX(),
                y = info.getPreferedOffsetForY(), z = info.getPreferedOffsetForZ();
        while (!Offsets.registerOffsets(info.getBaseType(), none, x, y, z)) {
            ...
            if (z == info.getPreferedOffsetForZ() && y == info.getPreferedOffsetForY() &&
                    x == info.getPreferedOffsetForX() && none == info.getPreferedOffsetForNone()) {

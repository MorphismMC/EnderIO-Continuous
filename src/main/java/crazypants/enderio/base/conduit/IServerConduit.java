...
public interface IServerConduit extends IConduit, ICapabilityProvider {
    ...
    /**
     * Tells the conduit that it has been part of an unsuccessful attempt to form a network. It is recommended that the
     * conduit waits a good amount of time before

...
public class EnderIOTab extends CreativeTabs {
    ...
    public static final @Nonnull CreativeTabs tabEnderIO, tabEnderIOItems, tabEnderIOMaterials, tabEnderIOMachines,
            tabEnderIOMobs, tabEnderIOConduits, tabEnderIOInvpanel;

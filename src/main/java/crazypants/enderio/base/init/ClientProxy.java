...
public class ClientProxy extends CommonProxy {
    ...
    public static void onModelRegistryEvent(@Nonnull ModelRegistryEvent event) {
        /*
         * Most blocks register themselves with the SmartModelAttacher which will also handle their items. Those that
         * don't need to implement IHaveRenderers and
         * have their items handled here.
         * 
         * Items that do _not_ belong to a block are handled here by either having the item implement IHaveRenderers or
         * by registering the default renderer.
         */

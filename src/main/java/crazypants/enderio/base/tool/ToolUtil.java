...
public class ToolUtil {
    ...
    public static boolean breakBlockWithTool(@Nonnull Block block, @Nonnull World world, @Nonnull BlockPos pos,
        ...
        if (tool != null && entityPlayer.isSneaking() && tool.canUse(hand, entityPlayer, pos)) {
            ...
            if (!PermissionAPI.hasPermission(entityPlayer.getGameProfile(), permissionNode,
                    new BlockPosContext(entityPlayer, pos, bs, side))) {

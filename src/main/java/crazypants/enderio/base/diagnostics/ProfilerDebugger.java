...
public class ProfilerDebugger extends Profiler {
    ...
    private String getFirst(RuntimeException ex) {
        ...
        for (int i = 0; i < stackTrace.length; i++) {
            ...
            if (!className.equals("crazypants.enderio.base.diagnostics.ProfilerEIO") &&
                    !className.equals("net.minecraft.profiler.Profiler") &&
    ...
    public static void init(FMLServerAboutToStartEvent event) {
        ReflectionHelper.setPrivateValue(MinecraftServer.class, event.getServer(), new ProfilerDebugger(), "profiler",
                "field_71304_b");
    }
}

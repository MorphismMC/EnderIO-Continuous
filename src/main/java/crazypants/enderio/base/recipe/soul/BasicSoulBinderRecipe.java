...
public class BasicSoulBinderRecipe extends AbstractSoulBinderRecipe {
    ...
    public BasicSoulBinderRecipe(@Nonnull ItemStack inputStack, @Nonnull ItemStack outputStack, int energyRequired,
    ...
    public BasicSoulBinderRecipe(@Nonnull ItemStack inputStack, @Nonnull ItemStack outputStack, int energyRequired,
                                 int xpRequired, @Nonnull String uid,
                                 @Nonnull RecipeLevel recipeLevel, @Nonnull NNList<ResourceLocation> entityNames,

...
public abstract class AbstractPainterTemplate<T> implements IMachineRecipe {
    ...
    protected abstract @Nonnull ResultStack[] produceCompletedResult(@Nonnull ItemStack paintSource,
    ...
    @Override
    public final @Nonnull ResultStack[] getCompletedResult(long nextSeed, float chanceMultiplier,
    ...
    private void applyExtraTags(final @Nonnull ItemStack target, @Nonnull final ItemStack paintSource,
                                final @Nonnull ResultStack[] result) {

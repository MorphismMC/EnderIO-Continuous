...
public class TriIntLookup<REC, LOB1, LOB2, LOB3> {
    ...
    public TriIntLookup(@Nonnull Function<LOB1, Integer> toId1, @Nonnull Function<LOB2, Integer> toId2,
                        @Nonnull Function<LOB3, Integer> toId3) {
        this.toId1 = toId1;
        this.toId2 = toId2;
        this.toId3 = toId3;
        root = makeNode1();
    ...
    public @Nonnull NNList<REC> getRecipes(@Nonnull LOB1 key1, @Nonnull LOB2 key2, @Nonnull LOB3 key3) {
        return FuncUtil.runIfOrSupNN(root.getNext(key1),
                r2 -> FuncUtil.runIf(r2.getNext(key2), r3 -> r3.getRecipes(key3)), () -> NNList.emptyList());
    }

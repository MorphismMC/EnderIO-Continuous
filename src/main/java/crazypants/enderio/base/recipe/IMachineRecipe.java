 ...
 * progress' recipe for a machine is
...
public interface IMachineRecipe {
     ...
     * a single 'cycle' of the recipe. For
     * examples, if the inputs would allow the recipe to completed 10 times, this method should only return the amount
     * of energy used for a single cycle.
     * 
     * @param inputs
     * @return
     */
     ...
     * example only one of two required inputs are
     ...
     * 
     * @param nextSeed
     *                         a random number to be used as a seed for determining whether '% chance' outputs are
     *                         returned. This value is in the range 0-1.
     ...
     * result of several recipe cycles, the
    ...
    /**
     * returns the recipe level of this recipe. If this recipe is a wrapper that handles multiple recipes with possibly
     * different level, this will return

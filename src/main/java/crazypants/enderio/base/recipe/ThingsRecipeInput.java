 ...
 * 
 * Please note that this input can become suddenly invalid after "load complete" as OreDict Things wait until then to
 * decide if an Oredict name actually exists.

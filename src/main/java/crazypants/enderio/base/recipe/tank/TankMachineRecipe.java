...
public class TankMachineRecipe implements IMachineRecipe {
    ...
    public enum Logic {
        ...
        XPBOTTLE {
            ...
            @Override
            @Nonnull
            public FluidStack convertFluidResult(boolean isFilling, @Nonnull ItemStack input,
                                                 @Nonnull FluidStack machineFluid, @Nonnull FluidStack recipeFluid,
        ...
        /**
         * Calculates the fluid amount based on the Dark Steel Upgrade's level cost. Only looks at the output item.
         * Forces the output item to be "enabled" if it not
         * already is.
         * <p>
         * see also
        ...
        DSU {
            ...
            @Override
            @Nonnull
            public ItemStack convertItemResult(boolean isFilling, @Nonnull ItemStack input,
                                               @Nonnull FluidStack machineFluid, @Nonnull FluidStack recipeFluid,
                                               @Nonnull ItemStack output) {
                IDarkSteelUpgrade upgrade = ItemUpgrades.getUpgrade(output);
    ...
    public @Nullable RecipeResult executeRecipe(@Nonnull ItemStack machineInput, @Nonnull FluidStack machineFluid) {
        ...
        result.itemResult = logic.convertItemResult(isFilling, machineInput, machineFluid, fluid,
                output.getItemStack());
        FluidStack fluidResult = logic.convertFluidResult(isFilling, machineInput, machineFluid, fluid,
                output.getItemStack());
    ...
    public TankMachineRecipe(@Nonnull String recipeName, boolean isFilling, @Nonnull Things input,
                             @Nonnull FluidStack fluid, Things output, @Nonnull Logic logic,
    ...
    @Override
    @Nonnull
    public ResultStack[] getCompletedResult(long nextSeed, float chanceMultiplier,
        ...
        if (recipeResult != null) {
            return new ResultStack[] { new ResultStack(recipeResult.itemResult),
                    new ResultStack(recipeResult.remainingInputFluid) };
        } else {

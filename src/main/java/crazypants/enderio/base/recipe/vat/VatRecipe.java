...
public class VatRecipe implements IRecipe {
    ...
    protected final @Nonnull Table<IRecipeInput, IRecipeInput, FluidStack> inputFluidStacks = NullHelper.notnull(
            HashBasedTable.create(),
            "HashBasedTable.create()");
    protected final @Nonnull Table<IRecipeInput, IRecipeInput, FluidStack> outputFluidStacks = NullHelper.notnull(
            HashBasedTable.create(),
            "HashBasedTable.create()");
                                ...
                                for (IRecipeInput r2 : inputs) {
                                    if (r2.isFluid()) {
                                        ...
                                        outputFluidStack.amount = Math
                                                .round(im * r2.getMulitplier() * Fluid.BUCKET_VOLUME);
                                        inputFluidStacks.put(r0, r1, inputFluidStack.copy());
                                        outputFluidStacks.put(r0, r1, outputFluidStack.copy());
                                        // TODO: Mod ee3
                                        // registerRecipe(outputFluidStack.copy(), r0.getInput().copy(),
                                        // r1.getInput().copy(), inputFluidStack.copy());
                                    }
                                }
                            }
                        }

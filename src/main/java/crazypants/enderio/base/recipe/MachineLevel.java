...
/**
 * Just a couple of constants to make the code a bit more readable. Machines (and recipes) can now use
 * "MachineLevel.XXX" to make clear some constant refers to

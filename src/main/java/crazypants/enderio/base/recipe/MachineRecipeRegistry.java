...
public class MachineRecipeRegistry {
    ...
    public @Nonnull RecipeGroupHolder<?> getRecipeHolderssForMachine(@Nonnull String machineName) {
        return NullHelper.notnullJ(
                machineRecipes.computeIfAbsent(machineName, unused -> new SimpleRecipeGroupHolder(false)),
                "map.computeIfAbsent");
    }
    ...
    public IMachineRecipe getRecipeForInputs(@Nonnull RecipeLevel machineLevel, @Nonnull String machineName,
    ...
    public IMachineRecipe getRecipeForInput(@Nonnull RecipeLevel machineLevel, @Nonnull String machineName,
                                            @Nonnull MachineRecipeInput input) {
    ...
    interface RecipeGroupHolder<REC extends IMachineRecipe> {
        ...
        REC getRecipeForInputs(@Nonnull RecipeLevel machineLevel, @Nonnull String machineName,
                               @Nonnull NNList<MachineRecipeInput> inputs);

        REC getRecipeForInput(@Nonnull RecipeLevel machineLevel, @Nonnull String machineName,
                              @Nonnull MachineRecipeInput input);
    }

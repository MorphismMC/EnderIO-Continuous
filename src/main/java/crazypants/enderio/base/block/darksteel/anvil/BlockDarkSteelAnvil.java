...
public class BlockDarkSteelAnvil extends BlockAnvil
                                 ...
                                 IEioGuiHandler.WithServerComponent, IModObject.WithBlockItem {
    ...
    public void registerRenderers(@Nonnull IModObject modObject) {
        for (Integer dmg : DAMAGE.getAllowedValues()) {
            ClientUtil.regRenderer(this, dmg,
                    DAMAGE.getName() + "=" + DAMAGE.getName(NullHelper.notnullM(dmg, "invalid property")) + "," +

...
public class BlockEnderCharge extends BlockConfusionCharge {
    ...
    public static void doEntityTeleport(EntityPrimedCharge entity) {
        ...
        world.playSound((EntityPlayer) null, entity.posX, entity.posY, entity.posZ, SoundEvents.ENTITY_GENERIC_EXPLODE,
                SoundCategory.BLOCKS, 1F,
                1.4f + ((world.rand.nextFloat() - world.rand.nextFloat()) * 0.2F));
        world.playSound((EntityPlayer) null, entity.posX, entity.posY, entity.posZ,
                SoundEvents.ENTITY_ENDERMEN_TELEPORT, SoundCategory.BLOCKS, 2F,
    ...
    public static void doTeleportEffect(World world, double x, double y, double z) {
        ...
        for (int i = 0; i < 100; ++i) {
            ...
            Particle entityfx = new ParticlePortal.Factory().createParticle(i, world, x + motionX * 0.1,
                    y + motionY * 0.1, z + motionZ * 0.1, motionX, motionY,
                    motionZ);

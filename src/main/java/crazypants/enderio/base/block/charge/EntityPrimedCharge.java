...
public class EntityPrimedCharge extends EntityTNTPrimed {
    ...
    public static void onEntityRegister(Register<EntityEntry> event) {
        EntityRegistry.registerModEntity(new ResourceLocation(EnderIO.DOMAIN, "primed_charge"),
                EntityPrimedCharge.class, EnderIO.DOMAIN + ".primed_charge", 0,
    ...
    private static final @Nonnull DataParameter<Integer> CHARGE = EntityDataManager
            .<Integer>createKey(EntityPrimedCharge.class, DataSerializers.VARINT);

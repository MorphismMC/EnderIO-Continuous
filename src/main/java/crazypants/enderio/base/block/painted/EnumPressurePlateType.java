...
public enum EnumPressurePlateType implements IStringSerializable {
    ...
    WOOD(true, Entity.class) {
        ...
        public void playClickOnSound(@Nonnull World worldIn, @Nonnull BlockPos pos) {
            worldIn.playSound((EntityPlayer) null, pos, SoundEvents.BLOCK_WOOD_PRESSPLATE_CLICK_ON,
    ...
    STONE(true, EntityLivingBase.class) {
        ...
        @Override
        public void playClickOnSound(@Nonnull World worldIn, @Nonnull BlockPos pos) {
            worldIn.playSound((EntityPlayer) null, pos, SoundEvents.BLOCK_STONE_PRESSPLATE_CLICK_ON,
    ...
    SOULARIUM(false, EntityLiving.class, EntitySlime.class, EntityGhast.class, EntityMob.class,
            EntitySkeletonHorse.class, EntityZombieHorse.class,
            EntityShulker.class),
        ...
        public @Nonnull Predicate<Entity> getPredicate(final @Nullable CapturedMob capturedMob) {
            return new Predicate<Entity>() {
                ...
                public boolean apply(@Nullable Entity entity) {
                    if (capturedMob == null || entity == null || !entity.isEntityAlive() ||
    ...
    private EnumPressurePlateType(boolean shadowsVanilla, @Nonnull CountingMode countingMode,
                                  @Nonnull Class<? extends Entity> searchClass) {
        this.shadowsVanilla = shadowsVanilla;
    ...
    public void playClickOnSound(@Nonnull World worldIn, @Nonnull BlockPos pos) {
        worldIn.playSound((EntityPlayer) null, pos, SoundEvents.BLOCK_METAL_PRESSPLATE_CLICK_ON, SoundCategory.BLOCKS,
                0.3F, 0.9F);
    }

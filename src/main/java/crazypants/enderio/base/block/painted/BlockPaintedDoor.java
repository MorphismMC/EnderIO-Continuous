...
public class BlockPaintedDoor extends BlockDarkSteelDoor
    ...
    public static BlockPaintedDoor create_wooden(@Nonnull IModObject modObject) {
        ...
        MachineRecipeRegistry.instance.registerRecipe(MachineRecipeRegistry.PAINTER,
                new DoorPainterTemplate(result, new IProducer() {
        ...
        MachineRecipeRegistry.instance.registerRecipe(MachineRecipeRegistry.PAINTER,
                new DoorPainterTemplate(result, modObject, result));
        return result;
    }
    ...
    public static BlockPaintedDoor create_dark(@Nonnull IModObject modObject) {
        ...
        result.init(modObject);
        MachineRecipeRegistry.instance.registerRecipe(MachineRecipeRegistry.PAINTER,
                new DoorPainterTemplate(result, ModObject.blockDarkSteelDoor,
                        ModObject.blockDarkSteelDoor.getBlockNN()));
        MachineRecipeRegistry.instance.registerRecipe(MachineRecipeRegistry.PAINTER,
                new DoorPainterTemplate(result, modObject, result));
        return result;
    }
    ...
    protected BlockDarkSteelDoor init(@Nonnull IModObject modObject) {
        ...
        PaintRegistry.registerModel("iron_door_bottom", new ResourceLocation("minecraft", "block/iron_door_bottom"),
                PaintRegistry.PaintMode.ALL_TEXTURES);
        PaintRegistry.registerModel("iron_door_top", new ResourceLocation("minecraft", "block/iron_door_top"),
                PaintRegistry.PaintMode.ALL_TEXTURES);
        PaintRegistry.registerModel("iron_door_bottom_rh",
                new ResourceLocation("minecraft", "block/iron_door_bottom_rh"), PaintRegistry.PaintMode.ALL_TEXTURES);
        PaintRegistry.registerModel("iron_door_top_rh", new ResourceLocation("minecraft", "block/iron_door_top_rh"),
                PaintRegistry.PaintMode.ALL_TEXTURES);
        PaintRegistry.registerModel("door_inventory", new ResourceLocation("minecraft", "item/iron_door"),
                PaintRegistry.PaintMode.ALL_TEXTURES);
        return this;
    }
    ...
    public void neighborChanged(@Nonnull IBlockState state, @Nonnull World worldIn, @Nonnull BlockPos pos,
        ...
        // partial copy from BlockDoor. Only those cases that destroy the lower door half---they've been modified to
        // allow the drop to contain paint data.
    ...
    public @Nonnull IBlockState getExtendedState(@Nonnull IBlockState state, @Nonnull IBlockAccess world,
        ...
        blockStateWrapper.addCacheKey(getPaintSource(state, world, pos)).addCacheKey(state.getValue(FACING))
                .addCacheKey(state.getValue(OPEN))
    ...
    public List<IBakedModel> mapItemRender(@Nonnull Block block, @Nonnull ItemStack stack) {
        ...
        IBakedModel model2 = PaintRegistry.getModel(IBakedModel.class, "door_inventory", stdOverlay,

...
public abstract class BlockPaintedReinforcedObsidian extends BlockReinforcedObsidianBase
    ...
    public static class BlockPaintedReinforcedObsidianSolid extends BlockPaintedReinforcedObsidian
    ...
    public static class BlockPaintedReinforcedObsidianNonSolid extends BlockPaintedReinforcedObsidian
    ...
    protected void init() {
        MachineRecipeRegistry.instance.registerRecipe(MachineRecipeRegistry.PAINTER,
                new BasicPainterTemplate<BlockPaintedReinforcedObsidian>(this,
                        ModObject.blockReinforcedObsidian.getBlockNN()) {

                    @Override
                    public int getEnergyRequired(@Nonnull NNList<MachineRecipeInput> inputs) {
                        return (int) (super.getEnergyRequired(inputs) *
                                RecipeConfig.energyFactorForReinforcedObsidian.get());
                    }
                });

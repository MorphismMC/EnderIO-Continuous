...
public abstract class BlockPaintedGlowstone extends BlockGlowstone
    ...
    public static class BlockPaintedGlowstoneSolid extends BlockPaintedGlowstone
    ...
    public static class BlockPaintedGlowstoneNonSolid extends BlockPaintedGlowstone
    ...
    @Override
    public void harvestBlock(@Nonnull final World worldIn, @Nonnull EntityPlayer player, @Nonnull final BlockPos pos,

    ...
    public @Nonnull EnumActionResult onItemUse(@Nonnull EntityPlayer player, @Nonnull World worldIn,
        ...
        if (facing != EnumFacing.UP) {
            ...
            if (player.canPlayerEdit(pos, facing, itemstack) && this.block.canPlaceBlockAt(worldIn, pos)) {
                ...
                // EIO ADD START
                this.block.setPaintSource(worldIn.getBlockState(pos), worldIn, pos,
                        PaintUtil.getSourceBlock(itemstack));
                this.block.setPaintSource(worldIn.getBlockState(pos.up()), worldIn, pos.up(),
                        PaintUtil.getSourceBlock(itemstack));
                // EIO ADD END

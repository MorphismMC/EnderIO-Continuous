...
public class BlockPaintedSlabManager {
    ...
    private static Block create(@Nonnull IModObject modObject, @Nonnull Material material, @Nonnull SoundType sound,
                                @Nonnull Block... paintables) {
        BlockPaintedSlab.BlockPaintedHalfSlab halfSlab = new BlockPaintedSlab.BlockPaintedHalfSlab(modObject, material,
                sound);
        ...
        MachineRecipeRegistry.instance.registerRecipe(MachineRecipeRegistry.PAINTER,
                new BasicPainterTemplate<BlockPaintedSlab>(halfSlab, paintables));
        return halfSlab;
    }

    private static Block create_double(@Nonnull IModObject modObject, @Nonnull Material material,
        ...
        if (modObject instanceof ModObject) {
            ...
            BlockPaintedSlab.BlockPaintedHalfSlab halfSlabBlock = (BlockPaintedSlab.BlockPaintedHalfSlab) halfSlabObject
                    .getBlockNN();

            BlockPaintedSlab.BlockPaintedDoubleSlab doubleSlab = new BlockPaintedSlab.BlockPaintedDoubleSlab(modObject,
                    material, halfSlabBlock, sound);
    ...
    public static Item create_item(@Nonnull IModObject modObject, @Nullable Block block) {
        final BlockItemPaintedSlab item = modObject
                .apply(new BlockItemPaintedSlab((BlockPaintedSlab) ((ModObject) modObject).getBlockNN()));

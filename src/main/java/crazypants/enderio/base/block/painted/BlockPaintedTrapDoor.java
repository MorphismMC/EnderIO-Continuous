...
public class BlockPaintedTrapDoor extends BlockDarkSteelTrapDoor implements ITileEntityProvider,
    ...
    public static BlockPaintedTrapDoor create_wooden(@Nonnull IModObject modObject) {
        ...
        MachineRecipeRegistry.instance.registerRecipe(MachineRecipeRegistry.PAINTER,
                new BasicPainterTemplate<BlockPaintedTrapDoor>(result, Blocks.TRAPDOOR));
        return result;
    }
    ...
    protected BlockDarkSteelTrapDoor init(@Nonnull IModObject modObject) {
        ...
        PaintRegistry.registerModel("trapdoor_bottom",
                new ResourceLocation("minecraft", "block/wooden_trapdoor_bottom"),
                PaintRegistry.PaintMode.ALL_TEXTURES);
        PaintRegistry.registerModel("trapdoor_top", new ResourceLocation("minecraft", "block/wooden_trapdoor_top"),
                PaintRegistry.PaintMode.ALL_TEXTURES);
        PaintRegistry.registerModel("trapdoor_open", new ResourceLocation("minecraft", "block/wooden_trapdoor_open"),
                PaintRegistry.PaintMode.ALL_TEXTURES);
        return this;
    }
    ...
    public List<IBakedModel> mapItemRender(@Nonnull Block block, @Nonnull ItemStack stack) {
        ...
        IBakedModel model2 = PaintRegistry.getModel(IBakedModel.class, "trapdoor_bottom", stdOverlay,

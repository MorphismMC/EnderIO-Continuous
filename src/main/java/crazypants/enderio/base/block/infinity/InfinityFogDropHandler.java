...
public class InfinityFogDropHandler {
    ...
    public static void onDrop(LivingDropsEvent event) {
        ...
        if (entity != null && NbtValue.INFINITY.getBoolean(entity.getEntityData()) &&
                entity.world.rand.nextFloat() < InfinityConfig.dropChanceFogCreatures.get()) {
            EntityItem entityitem = new EntityItem(entity.world, entity.posX, entity.posY, entity.posZ,
                    Material.POWDER_INFINITY.getStack());

...
public class BlockEndermanSkull extends BlockEio<TileEndermanSkull>
                                implements IHaveTESR, IHaveRenderers, IInfusionStabiliser {

    public static final @Nonnull PropertyEnum<SkullType> VARIANT = PropertyEnum.<SkullType>create("variant",
            SkullType.class);
    ...
    @Deprecated
    @Override
    public @Nonnull AxisAlignedBB getSelectedBoundingBox(@Nonnull IBlockState bs, @Nonnull World worldIn,
                                                         @Nonnull BlockPos pos) {

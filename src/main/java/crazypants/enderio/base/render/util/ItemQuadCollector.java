...
/**
 * This class can hold all quads a backed item model needs. It can collect them from multiple source, including other
 * ItemQuadCollectors.
 * <p>
 * <em>Details</em>
 * <p>
 * <strong>allFacesToGeneral</strong> - If allFacesToGeneral is set to true, all collected quads will be added to the
 * list of "general" quads. This is needed if
...
public class ItemQuadCollector {
    ...
    public void addBlockStates(List<Pair<IBlockState, ItemStack>> states, @Nonnull ItemStack parent,
                               Block parentBlock) {
        ...
        for (Pair<IBlockState, ItemStack> pair : states) {
            ...
            if (state != null) {
                ...
                addBakedModel(model, NullHelper.notnullJ(stack,
                        "If you see this, the world will be ending yesterday half past yellow!"));
            }
        }
    }

    public void addItemBlockStates(List<Pair<IBlockState, ItemStack>> states, @Nonnull ItemStack parent,
                                   Block parentBlock) {
        if (states == null || states.isEmpty()) {
            return;
        }
        ...
        for (Pair<IBlockState, ItemStack> pair : states) {
            ...
            if (state != null) {
                ...
                addItemModel(NullHelper.notnullJ(stack,
                        "If you see this, the world will be ending yesterday half past yellow!"));
            }
        }
    }

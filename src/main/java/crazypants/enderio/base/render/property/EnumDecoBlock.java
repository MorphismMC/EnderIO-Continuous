...
public enum EnumDecoBlock implements IStringSerializable {
    ...
    public static final @Nonnull PropertyEnum<EnumDecoBlock> TYPE = PropertyEnum.<EnumDecoBlock>create("type",
            EnumDecoBlock.class);
    ...
    public static @Nonnull EnumDecoBlock getTypeFromMeta(int meta) {
        return NullHelper.notnullJ(values()[meta >= 0 && meta < values().length ? meta : 0],
                "enum has null members...");
    }

...
/**
 * A property for the IO overlays of the block sides. These are implemented in the MachineIO dummy block and can be
 * pulled from there for rendering using these
 * blockstates.
 */

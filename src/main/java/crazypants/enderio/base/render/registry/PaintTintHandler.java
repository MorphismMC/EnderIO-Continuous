...
public class PaintTintHandler implements IBlockColor, IItemColor {
    ...
    public int colorMultiplier(@Nonnull ItemStack stack, int tintIndex) {
        ...
        if (block instanceof IPaintable) {
            ...
            if (paintSource != null) {
                final ItemStack paintStack = new ItemStack(paintSource.getBlock(), 1,
                        paintSource.getBlock().getMetaFromState(paintSource));
    ...
    @Override
    public int colorMultiplier(@Nonnull IBlockState state, @Nullable IBlockAccess world, @Nullable BlockPos pos,
                               int tintIndex) {

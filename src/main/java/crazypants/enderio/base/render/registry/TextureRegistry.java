...
public final class TextureRegistry {
    ...
    private static Function<ResourceLocation, Object> fallback = key -> {
        throw new UnsupportedOperationException(
                "TextureRegistry: Texture is accessed too early (or on a dedicated server): " + key);
    };
    ...
    @SafeVarargs
    private final static @Nonnull <P> P first(@Nonnull Class<P> clazz, @Nonnull ResourceLocation key,
                                              @Nonnull Function<ResourceLocation, ?/* super P */>... o) {

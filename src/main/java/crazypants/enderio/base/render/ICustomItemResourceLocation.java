...
/**
 * This interface is for items that get registered by the SmartModelLoader but do not have their own blockstate file,
 * using another block's one instead. The

...
public interface IEioGuiHandler {
    ...
    @Nullable
    Object getGuiElement(boolean server, @Nonnull EntityPlayer player, @Nonnull World world, @Nonnull BlockPos pos,
    ...
    public interface WithPos extends IEioGuiHandler.WithServerComponent {
        ...
        @Override
        default @Nullable Object getGuiElement(boolean server, @Nonnull EntityPlayer player, @Nonnull World world,
        ...
        @Nullable
        Container getServerGuiElement(@Nonnull EntityPlayer player, @Nonnull World world, @Nonnull BlockPos pos,
                                      @Nullable EnumFacing facing, int param1);

        @Nullable
        @SideOnly(Side.CLIENT)
        GuiScreen getClientGuiElement(@Nonnull EntityPlayer player, @Nonnull World world, @Nonnull BlockPos pos,
                                      @Nullable EnumFacing facing, int param1);
    }

    /**
     * This marker interface is needed for GUIs that are opened server-side. It will trigger the proper permissions to
     * be created.
     * 

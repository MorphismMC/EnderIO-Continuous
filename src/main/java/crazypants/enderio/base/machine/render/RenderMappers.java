...
public final class RenderMappers {
    ...
    public static final @Nonnull MachineRenderMapper SIMPLE_BODY_MAPPER = new MachineRenderMapper(
            EnumRenderPart.SIMPLE_BODY);

    public static final @Nonnull MachineRenderMapper ENHANCED_BODY_MAPPER = new MachineRenderMapper(
            EnumRenderPart.ENHANCED_BODY);

...
public class MachineRenderMapper implements IRenderMapper.IBlockRenderMapper,
    ...
    public List<IBlockState> mapBlockRender(@Nonnull IBlockStateWrapper state, @Nonnull IBlockAccess world,
        ...
        if ((tileEntity instanceof AbstractMachineEntity) && (block instanceof AbstractMachineBlock)) {
            return render(state.getState(), world, pos, blockLayer, (AbstractMachineEntity) tileEntity,
    ...
    @SideOnly(Side.CLIENT)
    protected @Nullable List<IBlockState> render(IBlockState state, IBlockAccess world, BlockPos pos,
        ...
        if (body != null) {
            states.add(ModObject.block_machine_base.getBlockNN().getDefaultState().withProperty(EnumRenderPart.SUB,
                    body.rotate(facing)));
        }
    ...
    @SideOnly(Side.CLIENT)
    protected EnumMap<EnumFacing, EnumIOMode> renderIO(@Nonnull AbstractMachineEntity tileEntity,
                                                       @Nonnull AbstractMachineBlock<?> block) {
    ...
    @SideOnly(Side.CLIENT)
    protected EnumMap<EnumFacing, EnumIOMode> renderPaintIO(@Nonnull AbstractMachineEntity tileEntity,
                                                            @Nonnull AbstractMachineBlock<?> block) {
        return null;
    }
    ...
    public @Nullable List<Pair<IBlockState, ItemStack>> mapItemRender(@Nonnull Block block, @Nonnull ItemStack stack,
        ...
        if (body_nullchecked != null) {
            states.add(Pair.of(ModObject.block_machine_base.getBlockNN().getDefaultState()
                    .withProperty(EnumRenderPart.SUB, body_nullchecked), stack));
        }
        states.add(Pair.of(
    ...
    @Override
    @SideOnly(Side.CLIENT)
    public EnumMap<EnumFacing, EnumIOMode> mapOverlayLayer(@Nonnull IBlockStateWrapper state,

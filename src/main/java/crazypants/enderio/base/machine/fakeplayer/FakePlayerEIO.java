...
public class FakePlayerEIO extends FakePlayer {
    ...
    // These do things with packets...which crashes since the net handler is null. Potion effects are not needed
    // anyways.
    @Override
    ...
    /**
     * Returns the UUID of the player who is responsible for this FakePlayer or null if no player is responsible or
     * known. May return the UUID of another fake

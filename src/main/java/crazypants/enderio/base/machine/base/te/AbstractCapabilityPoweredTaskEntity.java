...
public abstract class AbstractCapabilityPoweredTaskEntity extends AbstractCapabilityMachineEntity
    ...
    public AbstractCapabilityPoweredTaskEntity(@Nonnull ICapacitorKey maxEnergyRecieved,
    ...
    protected AbstractCapabilityPoweredTaskEntity(@Nonnull EnderInventory inv, @Nonnull ICapacitorKey maxEnergyRecieved,
                                                  @Nonnull ICapacitorKey maxEnergyStored,
                                                  @Nonnull ICapacitorKey maxEnergyUsed) {
    ...
    protected IMachineRecipe getNextRecipe() {
        if (cachedNextRecipe == null) {
            cachedNextRecipe = MachineRecipeRegistry.instance.getRecipeForInputs(getMachineLevel(), getMachineName(),
                    getRecipeInputs());
        }

...
public class EnergyLogic implements IEnergyLogic, ICap.NNFunction, Callback<ItemStack> {
    ...
    public EnergyLogic(AbstractCapabilityMachineEntity owner, @Nonnull IEnergyTank energy) {
        ...
        this.energy = energy;
        owner.getInventory().add(Type.UPGRADE, EnergyLogic.CAPSLOT,
                new InventorySlot(Filters.CAPACITORS, null, this, 1));
    ...
    public void serverTick() {
        ...
        if ((lastSyncPowerStored != scaledPower &&
                (lastSyncPowerStored == 0 || scaledPower == 0 || lastSyncWasLongAgo()))) {

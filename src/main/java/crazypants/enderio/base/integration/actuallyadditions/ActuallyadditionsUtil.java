...
public class ActuallyadditionsUtil {
    ...
    public static void registerHoes(@Nonnull EnderIOLifecycleEvent.Init.Pre event) {
        if (IntegrationConfig.enableActuallyAdditions.get()) {
            FarmersRegistry.registerHoes("actuallyadditions", "item_hoe_quartz", "item_hoe_emerald",
                    "item_hoe_obsidian", "item_hoe_crystal_red",
                    "item_hoe_crystal_blue", "item_hoe_crystal_light_blue", "item_hoe_crystal_black",
                    "item_hoe_crystal_green", "item_hoe_crystal_white");
        }
    }
}

...
public class ThaumcraftAspects {
    ...
    static void loadAspects() {
        ...
        registerObjectTag(Alloy.SOULARIUM.getOreIngot(),
        ...
        registerObjectTag(new ItemStack(ModObject.blockEndermanSkull.getBlockNN(), 1, SkullType.TORMENTED.ordinal()),
                new AspectList().add(getAspects(ModObject.blockEndermanSkull.getBlockNN()))
                        .add(getAspects(Items.POTIONITEM)).add(getAspects(Items.POTIONITEM))
                        .add(getAspects(new ItemStack(ModObject.itemBasicCapacitor.getItemNN(), 1, 0)))
        ...
        registerObjectTag(new ItemStack(ModObject.itemMaterial.getItemNN(), 1, Material.FRANKEN_ZOMBIE.ordinal()),
                new AspectList().add(Aspect.UNDEAD, 2)
                        .add(Aspect.MAN, 1).add(Aspect.EARTH, 1)
                        .add(getAspects(new ItemStack(ModObject.itemMaterial.getItemNN(), 1,
                                Material.ZOMBIE_CONTROLLER.ordinal()))));

        registerObjectTag(new ItemStack(ModObject.itemMaterial.getItemNN(), 1, Material.ENDER_RESONATOR.ordinal()),
                new AspectList().add(getAspects(ModObject.itemMaterial.getItemNN())).add(getAspects("itemSilicon"))
                        .add(getAspects("itemSilicon"))
        ...
        registerObjectTag(new ItemStack(ModObject.itemMaterial.getItemNN(), 1, Material.ATTRACTOR_CRYSTAL.ordinal()),
                new AspectList().add(Aspect.AIR, 2)
                        .add(Aspect.MAN, 3).add(getAspects(new ItemStack(ModObject.itemMaterial.getItemNN(), 1,
                                Material.VIBRANT_CRYSTAL.ordinal()))));
        ...
        registerObjectTag(new ItemStack(ModObject.blockFusedGlass.getBlockNN(), 1),
                new AspectList().add(Aspect.CRYSTAL, 2));

        registerObjectTag(new ItemStack(ModObject.blockEnlightenedFusedQuartz.getBlockNN(), 1),
                new AspectList().add(getAspects(new ItemStack(Items.QUARTZ, 4))).add(Aspect.LIGHT, 8).add(Aspect.SENSES,
                        2));
        ...
        Log.info("Thaumcraft integration: Added aspects for " + countItem + " items and " + countOredict +
    ...
    private static @Nonnull AspectList getAspects(@Nonnull String ore) {
        ...
        return ores.isEmpty() ? new AspectList() :
                getAspects(NullHelper.notnullF(ores.get(0), "oreDict " + ore + " has null stack"));
    }

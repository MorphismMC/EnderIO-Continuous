...
public class NaturaBerryFarmer extends PickableFarmer {
    ...
    public NaturaBerryFarmer(@Nonnull Block plantedBlock, int plantedBlockMeta, int grownBlockMeta,
    ...
    @Override
    public IHarvestResult harvestBlock(@Nonnull IFarmer farm, @Nonnull BlockPos bc,
                                       final @Nonnull IBlockState stateIn) {

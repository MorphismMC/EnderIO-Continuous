...
public class TicProxy {
    ...
    public static void registerTableCast(@Nonnull Things result, @Nonnull Things cast, Fluid fluid, float amount,
                                         boolean consumeCast) {
        if (isLoaded()) {
    ...
    public static void registerTableCast(@Nonnull Things result, @Nonnull Things cast, @Nonnull Things item,
                                         float amount, boolean consumeCast) {
        if (isLoaded()) {
    ...
    public static void registerBasinCasting(@Nonnull Things output, @Nonnull Things cast, @Nonnull Things fluid,
                                            float amount) {
        if (isLoaded()) {
            handler.registerBasinCasting(output, cast, fluid, amount);
        }
    ...
    public static void register(@Nonnull ITicRecipeHandler recipeInstance,
                                @Nonnull ITicModifierHandler modifierInstance) {

...
public interface ITicRecipeHandler {
    ...
    void registerTableCast(@Nonnull Things output, @Nonnull Things cast, Fluid fluid, float amount,
                           boolean consumeCast);

    void registerTableCast(@Nonnull Things output, @Nonnull Things cast, @Nonnull Things fluid, float amount,
                           boolean consumeCast);

...
public class TEUtil {
    ...
    public static void registerHoes(@Nonnull EnderIOLifecycleEvent.Init.Pre event) {
        FarmersRegistry.registerHoes("thermalfoundation", "tool.hoe_invar", "tool.hoe_copper", "tool.hoe_bronze",
                "tool.hoe_silver", "tool.hoe_electrum",
                "tool.hoe_tin", "tool.hoe_lead", "tool.hoe_nickel", "tool.hoe_platinum", "tool.hoe_aluminum",
                "tool.hoe_steel", "tool.hoe_constantan");
    }
}

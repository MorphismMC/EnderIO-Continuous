...
public class CustomSeedFarmer extends AbstractFarmerJoe {
    ...
    public CustomSeedFarmer(@Nonnull Block plantedBlock, int plantedBlockMeta, int grownBlockMeta,
    ...
    protected boolean canPlant(@Nonnull IFarmer farm, @Nonnull World world, @Nonnull BlockPos bc) {
        ...
        if (target.canPlaceBlockAt(world, bc) &&
                (ground.canSustainPlant(bs, world, groundPos, EnumFacing.UP, plantable) || ignoreSustainCheck) &&

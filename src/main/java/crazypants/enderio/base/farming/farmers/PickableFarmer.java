...
public class PickableFarmer extends CustomSeedFarmer {
    ...
    public PickableFarmer(@Nonnull Block plantedBlock, int plantedBlockMeta, int grownBlockMeta,
                          @Nonnull ItemStack seeds) {
    ...
    public IHarvestResult harvestBlock(@Nonnull IFarmer farm, @Nonnull final BlockPos pos, @Nonnull IBlockState state) {
        ...
        joe.interactionManager.processRightClickBlock(joe, joe.world, joe.getHeldItemMainhand(), EnumHand.MAIN_HAND,
                pos, EnumFacing.DOWN, 0, 0, 0);

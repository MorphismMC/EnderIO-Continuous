...
public class TreeHarvester implements Callback<BlockPos> {
    ...
    public static void harvest(@Nonnull final World world, @Nonnull final BlockPos pos,
                               @Nonnull final IHarvestResult res,
    ...
    private TreeHarvester(@Nonnull World world, @Nonnull BlockPos start, @Nonnull NonNullList<BlockPos> result,
                          @Nonnull IHarvestingTarget target) {
        this.world = world;
        this.result = result;
        this.next = start;
        this.target = target;

...
class RegistryCallbacks implements IForgeRegistry.AddCallback<IFarmerJoe>, IForgeRegistry.ClearCallback<IFarmerJoe>,
                        IForgeRegistry.CreateCallback<IFarmerJoe> {
    ...
    @Override
    public void onAdd(IForgeRegistryInternal<IFarmerJoe> owner, RegistryManager stage, int id, IFarmerJoe joe,
                      @Nullable IFarmerJoe oldObj) {

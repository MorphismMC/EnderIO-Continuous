...
public class Fertilizer {
    ...
    public static void registerRegistry(@Nonnull RegistryEvent.NewRegistry event) {
        REGISTRY = new RegistryBuilder<IFertilizer>().setName(new ResourceLocation(EnderIO.DOMAIN, "fertilizer"))
                .setType(IFertilizer.class)
     ...
     * fertilizer, it will return an instance of

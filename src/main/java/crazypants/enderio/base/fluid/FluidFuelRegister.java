...
public class FluidFuelRegister implements IFluidRegister {
    ...
    public void addCoolant(String fluidName, float degreesCoolingPerMB) {
        addCoolant(NullHelper.notnullF(FluidRegistry.getFluid(fluidName), "Invalid fluid " + fluidName),
                degreesCoolingPerMB);
    }
    ...
    public void addFuel(NBTTagCompound tag) {
        ...
        addFuel(tag.getString(KEY_FLUID_NAME), tag.getInteger(KEY_POWER_PER_CYCLE),
                tag.getInteger(KEY_TOTAL_BURN_TIME));
    }

    public void addFuel(String fluidName, int powerPerCycleRF, int totalBurnTime) {
        addFuel(NullHelper.notnullF(FluidRegistry.getFluid(fluidName), "Invalid fluid " + fluidName), powerPerCycleRF,
                totalBurnTime);
    }

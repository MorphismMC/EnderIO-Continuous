...
public class BlockEndergyAlloy extends BlockEio<TileEntityEio> implements IAdvancedTooltipProvider, IHaveRenderers {
    ...
    public static final @Nonnull PropertyEnum<AlloyEndergy> VARIANT = PropertyEnum.<AlloyEndergy>create("variant",
            AlloyEndergy.class);
    ...
    public void registerRenderers(@Nonnull IModObject modObject) {
        NNList.of(AlloyEndergy.class).apply(new Callback<AlloyEndergy>() {
            ...
            public void apply(@Nonnull AlloyEndergy alloy) {
                ClientUtil.regRenderer(BlockEndergyAlloy.this, AlloyEndergy.getMetaFromType(alloy),
                        VARIANT.getName() + "=" + VARIANT.getName(alloy));
            }
        });
    }
    ...
    public float getExplosionResistance(@Nonnull World world, @Nonnull BlockPos pos, @Nullable Entity exploder,
        ...
        return getBlockHardness(world.getBlockState(pos), world, pos) * 2.0f; // vanilla default is / 5.0f, this means
                                                                              // hardness*2 = resistance
    }

...
public abstract class BlockFusedQuartzBase<T extends TileEntityEio> extends BlockEio<T>
    ...
    @Override
    public boolean doesSideBlockChestOpening(@Nonnull IBlockState blockStateIn, @Nonnull IBlockAccess world,
    ...
    public static class BlockItemFusedQuartzBase extends BlockItemPaintedBlock
                                                 implements ICustomItemResourceLocation, IOverlayRenderAware {

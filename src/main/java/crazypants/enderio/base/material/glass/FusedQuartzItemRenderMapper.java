...
public class FusedQuartzItemRenderMapper implements IItemRenderMapper.IDynamicOverlayMapper,
    ...
    public ItemQuadCollector mapItemDynamicOverlayRender(@Nonnull Block block, @Nonnull ItemStack stack) {
        if (NbtValue.FAKE.hasTag(stack)) {
            // this is for the TOP overlay, kind of a hack putting it here, but the alternative would be adding a new
            // item just for this...

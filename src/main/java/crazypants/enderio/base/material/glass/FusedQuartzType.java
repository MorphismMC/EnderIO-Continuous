...
public enum FusedQuartzType implements IStringSerializable {
    ...
    HOLY_ENLIGHTENED_FUSED_QUARTZ("holyEnlightenedFusedQuartz", BaseMaterial.QUARTZ, Upgrade.ENLIGHTENED,
            IPassingCallback.PLAYER, 0),
    HOLY_ENLIGHTENED_FUSED_GLASS("holyEnlightenedFusedGlass", BaseMaterial.GLASS, Upgrade.ENLIGHTENED,
            IPassingCallback.PLAYER, 0),
    ...
    UNHOLY_ENLIGHTENED_FUSED_QUARTZ("unholyEnlightenedFusedQuartz", BaseMaterial.QUARTZ, Upgrade.ENLIGHTENED,
            IPassingCallback.MOB, 0),
    UNHOLY_ENLIGHTENED_FUSED_GLASS("unholyEnlightenedFusedGlass", BaseMaterial.GLASS, Upgrade.ENLIGHTENED,
            IPassingCallback.MOB, 0),
    ...
    PASTURE_ENLIGHTENED_FUSED_QUARTZ("pastureEnlightenedFusedQuartz", BaseMaterial.QUARTZ, Upgrade.ENLIGHTENED,
            IPassingCallback.ANIMAL, 1),
    PASTURE_ENLIGHTENED_FUSED_GLASS("pastureEnlightenedFusedGlass", BaseMaterial.GLASS, Upgrade.ENLIGHTENED,
            IPassingCallback.ANIMAL, 1),
    PASTURE_DARK_FUSED_QUARTZ("pastureDarkFusedQuartz", BaseMaterial.QUARTZ, Upgrade.DARKENED, IPassingCallback.ANIMAL,
            1),
    ...
    NOT_HOLY_ENLIGHTENED_FUSED_QUARTZ("notHolyEnlightenedFusedQuartz", BaseMaterial.QUARTZ, Upgrade.ENLIGHTENED,
            IPassingCallback.NON_PLAYER, 1),
    NOT_HOLY_ENLIGHTENED_FUSED_GLASS("notHolyEnlightenedFusedGlass", BaseMaterial.GLASS, Upgrade.ENLIGHTENED,
            IPassingCallback.NON_PLAYER, 1),
    NOT_HOLY_DARK_FUSED_QUARTZ("notHolyDarkFusedQuartz", BaseMaterial.QUARTZ, Upgrade.DARKENED,
            IPassingCallback.NON_PLAYER, 1),
    NOT_HOLY_DARK_FUSED_GLASS("notHolyDarkFusedGlass", BaseMaterial.GLASS, Upgrade.DARKENED,
            IPassingCallback.NON_PLAYER, 1),
    ...
    NOT_UNHOLY_ENLIGHTENED_FUSED_QUARTZ("notUnholyEnlightenedFusedQuartz", BaseMaterial.QUARTZ, Upgrade.ENLIGHTENED,
            IPassingCallback.NON_MOB, 2),
    NOT_UNHOLY_ENLIGHTENED_FUSED_GLASS("notUnholyEnlightenedFusedGlass", BaseMaterial.GLASS, Upgrade.ENLIGHTENED,
            IPassingCallback.NON_MOB, 2),
    NOT_UNHOLY_DARK_FUSED_QUARTZ("notUnholyDarkFusedQuartz", BaseMaterial.QUARTZ, Upgrade.DARKENED,
            IPassingCallback.NON_MOB, 2),
    NOT_UNHOLY_DARK_FUSED_GLASS("notUnholyDarkFusedGlass", BaseMaterial.GLASS, Upgrade.DARKENED,
            IPassingCallback.NON_MOB, 2),

    NOT_PASTURE_FUSED_QUARTZ("notPastureFusedQuartz", BaseMaterial.QUARTZ, Upgrade.NONE, IPassingCallback.NON_ANIMAL,
            2),
    NOT_PASTURE_FUSED_GLASS("notPastureFusedGlass", BaseMaterial.GLASS, Upgrade.NONE, IPassingCallback.NON_ANIMAL, 2),
    NOT_PASTURE_ENLIGHTENED_FUSED_QUARTZ("notPastureEnlightenedFusedQuartz", BaseMaterial.QUARTZ, Upgrade.ENLIGHTENED,
            IPassingCallback.NON_ANIMAL, 2),
    NOT_PASTURE_ENLIGHTENED_FUSED_GLASS("notPastureEnlightenedFusedGlass", BaseMaterial.GLASS, Upgrade.ENLIGHTENED,
            IPassingCallback.NON_ANIMAL, 2),
    NOT_PASTURE_DARK_FUSED_QUARTZ("notPastureDarkFusedQuartz", BaseMaterial.QUARTZ, Upgrade.DARKENED,
            IPassingCallback.NON_ANIMAL, 2),
    NOT_PASTURE_DARK_FUSED_GLASS("notPastureDarkFusedGlass", BaseMaterial.GLASS, Upgrade.DARKENED,
            IPassingCallback.NON_ANIMAL, 2),
    ...
    public static final @Nonnull PropertyEnum<FusedQuartzType> KIND = PropertyEnum.<FusedQuartzType>create("kind",
            FusedQuartzType.class);

    public static final @Nonnull PropertyEnum<FusedQuartzType> KIND0 = PropertyEnum.<FusedQuartzType>create("kind",
            FusedQuartzType.class,
            type -> type != null && type.getGrouping() == 0);

    public static final @Nonnull PropertyEnum<FusedQuartzType> KIND1 = PropertyEnum.<FusedQuartzType>create("kind",
            FusedQuartzType.class,
            type -> type != null && type.getGrouping() == 1);

    public static final @Nonnull PropertyEnum<FusedQuartzType> KIND2 = PropertyEnum.<FusedQuartzType>create("kind",
            FusedQuartzType.class,
    ...
    public boolean connectTo(FusedQuartzType other) {
        return other != null &&
                ((BlockConfig.clearGlassConnectToFusedQuartz.get() && BlockConfig.glassConnectToTheirVariants.get()) ||

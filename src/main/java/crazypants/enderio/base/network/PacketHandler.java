...
public final class PacketHandler {
    ...
    public static void init(FMLInitializationEvent event) {
        ...
        INSTANCE.registerMessage(PacketExperienceContainer.Handler.class, PacketExperienceContainer.class, nextID(),
                Side.CLIENT);
        INSTANCE.registerMessage(PacketConduitProbe.Handler.class, PacketConduitProbe.class, nextID(), Side.SERVER);
        INSTANCE.registerMessage(PacketConduitProbeMode.Handler.class, PacketConduitProbeMode.class, nextID(),
                Side.SERVER);
        INSTANCE.registerMessage(PacketYetaWrenchDisplayMode.Handler.class, PacketYetaWrenchDisplayMode.class, nextID(),
                Side.SERVER);
        INSTANCE.registerMessage(PacketXpTransferEffects.Handler.class, PacketXpTransferEffects.class, nextID(),
                Side.CLIENT);
        INSTANCE.registerMessage(PacketTravelEvent.Handler.class, PacketTravelEvent.class, nextID(), Side.SERVER);
        INSTANCE.registerMessage(PacketAddRemoveChannel.Handler.class, PacketAddRemoveChannel.class, nextID(),
                Side.CLIENT);
        INSTANCE.registerMessage(PacketAddRemoveChannel.Handler.class, PacketAddRemoveChannel.class, nextID(),
                Side.SERVER);
        INSTANCE.registerMessage(PacketChannelList.Handler.class, PacketChannelList.class, nextID(), Side.CLIENT);
        INSTANCE.registerMessage(PacketDarkSteelPowerUse.Handler.class, PacketDarkSteelPowerUse.class, nextID(),
                Side.SERVER);
        INSTANCE.registerMessage(PacketUpgradeState.ServerHandler.class, PacketUpgradeState.class, nextID(),
                Side.SERVER);
        INSTANCE.registerMessage(PacketUpgradeState.ClientHandler.class, PacketUpgradeState.class, nextID(),
                Side.CLIENT);
        ...
        INSTANCE.registerMessage(PacketLegacyPowerStorage.Handler.class, PacketLegacyPowerStorage.class, nextID(),
                Side.CLIENT);
        ...
        INSTANCE.registerMessage(PacketUpdateLocationPrintout.Handler.class, PacketUpdateLocationPrintout.class,
                nextID(), Side.SERVER);
        ...
        INSTANCE.registerMessage(PacketDarkSteelSFX.ServerHandler.class, PacketDarkSteelSFX.class, nextID(),
                Side.SERVER);
        INSTANCE.registerMessage(PacketDarkSteelSFX.ClientHandler.class, PacketDarkSteelSFX.class, nextID(),
                Side.CLIENT);
        INSTANCE.registerMessage(PacketFilterUpdate.Handler.class, PacketFilterUpdate.class, nextID(), Side.SERVER);
        INSTANCE.registerMessage(PacketExistingItemFilterSnapshot.Handler.class, PacketExistingItemFilterSnapshot.class,
                nextID(), Side.SERVER);
        INSTANCE.registerMessage(PacketHeldFilterUpdate.Handler.class, PacketHeldFilterUpdate.class, nextID(),
                Side.SERVER);

...
public class PaintHelper {
    ...
    @SideOnly(Side.CLIENT)
    public static boolean addHitEffects(@Nonnull IBlockState state, @Nonnull World world,
        ...
        if (state.getBlock() instanceof IPaintable) {
            ...
            if (paintSource != null) {
                ...
                lastTexture = Minecraft.getMinecraft().getBlockRendererDispatcher().getBlockModelShapes()
                        .getTexture(paintSource);
                return true;
            }
        }
        return false;
    ...
    @SideOnly(Side.CLIENT)
    public static void addBlockHitEffects(@Nonnull World world, @Nonnull IBlockState realBlock,
                                          @Nonnull IBlockState paintBlock, @Nonnull BlockPos pos,
        ...
        double d0 = i + rand.nextDouble() * (axisalignedbb.maxX - axisalignedbb.minX - f * 2.0F) + f +
                axisalignedbb.minX;
        double d1 = j + rand.nextDouble() * (axisalignedbb.maxY - axisalignedbb.minY - f * 2.0F) + f +
                axisalignedbb.minY;
        double d2 = k + rand.nextDouble() * (axisalignedbb.maxZ - axisalignedbb.minZ - f * 2.0F) + f +
                axisalignedbb.minZ;
        ...
        Particle digFX = Minecraft.getMinecraft().effectRenderer.spawnEffectParticle(
                EnumParticleTypes.BLOCK_CRACK.getParticleID(), i, j, k, 0, 0, 0,
    ...
    @SideOnly(Side.CLIENT)
    public static boolean addDestroyEffects(@Nonnull World world, @Nonnull BlockPos pos,
                                            @Nonnull ParticleManager effectRenderer) {
        ...
        if (state.getBlock() instanceof IPaintable) {
            IBlockState paintSource = ((IPaintable) state.getBlock()).getPaintSource(state, world, pos);
            if (paintSource != null) {
                texture = Minecraft.getMinecraft().getBlockRendererDispatcher().getBlockModelShapes()
                        .getTexture(paintSource);
            }
        }
        if (texture == null) {

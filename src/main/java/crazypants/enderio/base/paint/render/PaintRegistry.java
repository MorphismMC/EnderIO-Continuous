...
public class PaintRegistry {
    ...
    private static class PaintRegistryClient extends PaintRegistryServer {
        ...
        protected void init() {
            ...
            OVERLAY_TRANSFORMATION2 = new TRSRTransformation(new Vector3f(-0.01f, -0.01f, -0.01f), null,
                    new Vector3f(1.02f, 1.02f, 1.02f), null);
            OVERLAY_TRANSFORMATION3 = new TRSRTransformation(new Vector3f(-0.01f, -0.01f, -0.01f), null,
                    new Vector3f(1.02f, 1.04f, 1.02f), null);
            OVERLAY_TRANSFORMATION4 = new TRSRTransformation(new Vector3f(-0.0105f, -0.0095f, -0.01f), null,
                    new Vector3f(1.02f, 1.02f, 1.02f), null);
        }
        ...
        @SideOnly(Side.CLIENT)
        private IBakedModel paintModel(IModel sourceModel, final @Nullable IBlockState paintSource,
                                       IModelState rotation, final PaintMode paintMode) {
            ...
            final TextureAtlasSprite paintSprite = paintSource == null ? missingSprite : NullHelper.first(
                    Minecraft.getMinecraft().getBlockRendererDispatcher().getBlockModelShapes().getTexture(paintSource),
                    missingSprite);

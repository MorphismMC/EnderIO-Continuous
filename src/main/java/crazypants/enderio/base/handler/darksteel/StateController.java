...
public class StateController {
    ...
    /**
     * When a player starts tracking another player, sync a complete set of flags of the tracked player to the tracking
     * player.
     * <p>
    ...
    public static boolean isActive(@Nonnull EntityPlayer player, @Nullable IDarkSteelUpgrade type) {
        ...
        return type != null && (activeSet.hasKey(type.getKeybindingID()) ?
                activeSet.getBoolean(type.getKeybindingID()) : type.keybindingDefault());
    }
    ...
    public static void setActive(@Nonnull EntityPlayer player, @Nonnull String type, boolean isActive) {
        if (player.world.isRemote) {
            ...
            PacketHandler.INSTANCE.sendToDimension(new PacketUpgradeState(type, isActive, player.getEntityId()),

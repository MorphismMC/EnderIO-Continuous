...
public abstract class AbstractUpgrade extends Impl<IDarkSteelUpgrade>
                                      implements IAdvancedTooltipProvider, IDarkSteelUpgrade {
    ...
    protected AbstractUpgrade(@Nonnull String domain, @Nonnull String id, @Nonnull String unlocName,
    ...
    protected AbstractUpgrade(@Nonnull String domain, @Nonnull String id, int variant, @Nonnull String unlocName,
                              IValue<Integer> levelCost) {
    ...
    public int getUpgradeVariantLevel(@Nonnull ItemStack stack) {
        final NBTTagCompound tagCompound = NbtValue.getReadOnlyRoot(stack);
        return tagCompound.hasKey(id) && tagCompound.getCompoundTag(id).hasKey(KEY_VARIANT) ?
                tagCompound.getCompoundTag(id).getInteger(KEY_VARIANT) : -1;
    }

...
public class ServerTickHandler {
    ...
    public static void addListener(@Nonnull WorldServer world, @Nonnull IServerTickListener listener) {
        worldListeners.computeIfAbsent(world, k -> new IdentityHashMap<>()).put(listener,
    ...
    public static void onWorldTick(@Nonnull TickEvent.WorldTickEvent event) {
        ...
        worldListeners.computeIfAbsent((WorldServer) event.world, k -> new IdentityHashMap<>())
    ...
    public static void onServerTick(@Nonnull TickEvent.ServerTickEvent event) {
        ...
        for (Entry<ITickListener, String> entry : ImmutableSet
                .copyOf(NullHelper.notnullJ(listeners.entrySet(), "IdentityHashMap.entrySet()"))) {

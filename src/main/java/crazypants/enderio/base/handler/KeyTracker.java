...
public enum KeyTracker {
    ...
    stepassist(Keyboard.KEY_NONE, CATEGORY.DARKSTEELARMOR,
            toggleStateAction(StepAssistUpgrade::isEquipped, StepAssistUpgrade.INSTANCE)),
    speed(Keyboard.KEY_NONE, CATEGORY.DARKSTEELARMOR,
            toggleStateAction(SpeedUpgrade::isEquipped, SpeedUpgrade.SPEED_ONE)),
    ...
    tnt(Keyboard.KEY_NONE, CATEGORY.DARKSTEELARMOR,
            toggleStateAction(ExplosiveUpgrade::isEquipped, ExplosiveUpgrade.INSTANCE)),
    ...
    private KeyTracker(int keyCode, @Nonnull String category, @Nullable Action action) {
        this.binding = new KeyBinding("enderio.keybind." + name().toLowerCase(Locale.ENGLISH), keyCode,
                StringUtil.trim(category));
    ...
    public static @Nonnull Action toggleStateAction(@Nonnull Predicate<EntityPlayer> condition,
                                                    @Nonnull IDarkSteelUpgrade type) {
        return () -> {
        ...
        public void execute() {
            ...
            if (activeMagnet != null) {
                ...
                PacketHandler.INSTANCE
                        .sendToServer(new PacketMagnetState(SlotType.INVENTORY, activeMagnet.getSlot(), isActive));
                return;
            }
    ...
    private static class YetaWrenchAction implements Action {
        ...
        public void execute() {
            ...
            if (equipped.getItem() instanceof IConduitControl) {
                ...
                PacketHandler.INSTANCE
                        .sendToServer(new PacketYetaWrenchDisplayMode(player.inventory.currentItem, newMode));
    ...
    private static class NightVisionAction implements Action {
        ...
        public void execute() {
            ...
            if (DarkSteelController.isNightVisionUpgradeEquipped(player)) {
                ...
                if (isActive) {
                    SoundHelper.playSound(player.world, player, SoundRegistry.NIGHTVISION_ON, 0.1f,
                            player.world.rand.nextFloat() * 0.4f - 0.2f + 1.0f);
                } else {
                ...
                StringUtil.sendEnabledChatMessage(Minecraft.getMinecraft().player,
                        NightVisionUpgrade.INSTANCE.getUnlocalizedName(), isActive);
            }
        }
    }
    ...
    private static class TopAction implements Action {
        ...
        public void execute() {
            ...
            if (DarkSteelController.isTopUpgradeEquipped(player)) {
                ...
                StringUtil.sendEnabledChatMessage(Minecraft.getMinecraft().player,
                        TheOneProbeUpgrade.INSTANCE.getUnlocalizedName(), isActive);
            }
        }
    }
}

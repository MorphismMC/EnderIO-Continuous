...
public class RecipeButtonHandler {
    ...
    public static void onGuiInit(InitGuiEvent.Post event) {
        ...
        if (gui != null && (gui instanceof GuiInventory || gui instanceof GuiCrafting) &&
                (PersonalConfig.recipeButtonDisableAlways.get() || ((PersonalConfig.recipeButtonReplaceWithJei.get() ||
                        PersonalConfig.recipeButtonDisableWithJei.get()) && JeiAccessor.isJeiRuntimeAvailable()))) {
            ...
            while (iterator.hasNext()) {
                ...
                if (button instanceof GuiButtonImage && button.id == 10) {
                    ...
                    if (PersonalConfig.recipeButtonReplaceWithJei.get() && JeiAccessor.isJeiRuntimeAvailable()) {
                        event.getButtonList()
                                .add(new WrapperGuiButton((GuiButtonImage) button, (IRecipeShownListener) gui));
                    }
                    return;
                }
            }

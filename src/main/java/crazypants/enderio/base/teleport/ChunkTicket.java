...
/**
 * A short-term chunkloading manager meant to keep both source and target chunk of a long-range player teleport
 * chunkloaded for 5 seconds. This could help
...
public class ChunkTicket {
    ...
    public static void onPreInit(EnderIOLifecycleEvent.PreInit event) {
        // must register something, but the code that read that back is null-safe---in which case tickets are silently
        // discarded on world load. Which is perfect of

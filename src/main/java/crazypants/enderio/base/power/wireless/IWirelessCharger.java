...
public interface IWirelessCharger {
     ...
     * <p>
     * It is not expected that this value differs between chargers, it's here to allow the config value to propagate
     * from machines to base.
     */
    boolean forceSingle();

    /**
     * Messaging exception that tells the calling code that the charger should be (and potentially already has been!)
     * removed from the list of chargers.
     * <p>

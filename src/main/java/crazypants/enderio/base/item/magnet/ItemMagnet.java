...
public class ItemMagnet extends AbstractPoweredItem
                        implements IResourceTooltipProvider, IBauble, IOverlayRenderAware, IHasPlayerRenderer {
    ...
    public static boolean hasPower(@Nonnull ItemStack itemStack) {
        int energyStored = itemStack.getItem() instanceof IInternalPoweredItem ?
                ((IInternalPoweredItem) itemStack.getItem()).getEnergyStored(itemStack) : 0;
    ...
    public void onWornTick(ItemStack itemstack, EntityLivingBase player) {
        ...
        if (player instanceof EntityPlayer && isActive(itemstack) && hasPower(itemstack) &&
    ...
    public boolean canEquip(ItemStack itemstack, EntityLivingBase player) {
        ...
        return ItemConfig.magnetAllowInBaublesSlot.get() &&
                (ItemConfig.magnetAllowDeactivatedInBaublesSlot.get() || isActive(itemstack));
    }

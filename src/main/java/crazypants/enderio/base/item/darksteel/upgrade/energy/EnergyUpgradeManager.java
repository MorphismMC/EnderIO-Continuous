...
public abstract class EnergyUpgradeManager {
    ...
    public static int extractEnergy(@Nonnull ItemStack container, @Nonnull IDarkSteelItem item, int maxExtract,
                                    boolean simulate) {
    ...
    public static int extractEnergy(@Nonnull ItemStack container, @Nonnull IDarkSteelItem item,
                                    IValue<Integer> maxExtract, boolean simulate) {
        EnergyUpgradeHolder eu = loadFromItem(container);
        if (eu == null) {
            return 0;
        }
    ...
    public static int receiveEnergy(@Nonnull ItemStack container, @Nonnull IDarkSteelItem item, int maxReceive,
                                    boolean simulate) {
        EnergyUpgradeHolder eu = loadFromItem(container);
        if (eu == null) {
            return 0;

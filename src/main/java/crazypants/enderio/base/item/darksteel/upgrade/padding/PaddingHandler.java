...
public class PaddingHandler {
    ...
    public static void onPlaySoundEvent(PlaySoundEvent event) {
        ...
        if (NullHelper.untrust(player) != null &&
                PaddingUpgrade.INSTANCE.hasUpgrade(player.getItemStackFromSlot(EntityEquipmentSlot.HEAD)) &&
    ...
    private static class MutedSound implements ISound {
        ...
        public float getVolume() {
            ...
            if (NullHelper.untrust(player) != null &&
                ...
                final float volume = MathHelper.clamp((float) (distanceSq / (cutoffDistance * cutoffDistance)), .1f,
                        1f);

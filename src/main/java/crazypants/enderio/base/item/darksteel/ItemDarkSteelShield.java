...
public class ItemDarkSteelShield extends ItemShield
                                 ...
                                 IHaveRenderers, AnvilUpgrade.INoAnvilUpgrade {
    ...
    public @Nonnull String getItemStackDisplayName(@Nonnull ItemStack stack) {
        if (stack.getSubCompound("BlockEntityTag") != null) {
            ...
            return EnderIO.lang
                    .localizeExact(getTranslationKey(stack) + "." + enumdyecolor.getTranslationKey() + DOT_COM);
        } else {
    ...
    protected @Nonnull ArmorMaterial getMaterial(@Nonnull ItemStack stack) {
        return EnergyUpgradeManager.getEnergyStored(stack) > 0 ? data.getArmorMaterialEmpowered() :
                data.getArmorMaterial();
    }
    ...
    public @Nonnull Multimap<String, AttributeModifier> getAttributeModifiers(@Nonnull EntityEquipmentSlot equipmentSlot,
        ...
        if (equipmentSlot == EntityEquipmentSlot.MAINHAND || equipmentSlot == EntityEquipmentSlot.OFFHAND) {
            ...
            multimap.put(SharedMonsterAttributes.ARMOR_TOUGHNESS.getName(),
                    new AttributeModifier(uuid1, "Shield toughness", armorMaterial.getToughness(), 0));
            multimap.put(EntityLivingBase.SWIM_SPEED.getName(), new AttributeModifier(uuid2, "Shield swimming", -0.5,

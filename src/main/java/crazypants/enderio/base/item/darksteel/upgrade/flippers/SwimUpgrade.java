...
public class SwimUpgrade extends AbstractUpgrade {
    ...
    private static final @Nonnull AttributeModifier BOOST = new AttributeModifier(UPGRADE_UUID, UPGRADE_NAME,
            DarkSteelConfig.swimSpeed.get(),
    ...
    private static final @Nonnull AttributeModifier BOOST_DS = new AttributeModifier(UPGRADE_UUID, UPGRADE_NAME,
            DarkSteelConfig.swimSpeedDepthStrider.get(),
            Constants.AttributeModifierOperation.ADD) {

...
public final class ElytraUpgradeLayer implements IRenderUpgrade {
    ...
    private static final @Nonnull ResourceLocation TEXTURE_ELYTRA = new ResourceLocation(EnderIO.DOMAIN,
    ...
    @Override
    public void doRenderLayer(@Nonnull RenderPlayer renderPlayer, EntityEquipmentSlot equipmentSlot,
                              @Nonnull ItemStack piece,
                              @Nonnull AbstractClientPlayer entitylivingbaseIn, float limbSwing, float limbSwingAmount,
        ...
        if (entitylivingbaseIn.isPlayerInfoSet() && locationElytra != null) {
            ...
            if (entitylivingbaseIn.hasPlayerInfo() && locationCape != null &&
        ...
        modelElytra.setRotationAngles(limbSwing, limbSwingAmount, ageInTicks, netHeadYaw, headPitch, scale,
                entitylivingbaseIn);
        ...
        if (piece.isItemEnchanted()) {
            LayerArmorBase.renderEnchantedGlint(renderPlayer, entitylivingbaseIn, modelElytra, limbSwing,
                    limbSwingAmount, partialTicks, ageInTicks, netHeadYaw,
                    headPitch, scale);
        }

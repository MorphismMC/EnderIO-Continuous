...
public class EnergyUpgrade extends AbstractUpgrade {
    ...
    public static final @Nonnull NNList<EnergyUpgrade> UPGRADES = new NNList<>(
            new EnergyUpgrade(EnergyUpgradeManager.UPGRADE_NAME, 0, "enderio.darksteel.upgrade.empowered_one",
                    DarkSteelConfig.energyUpgradeLevelCostEmpowered0),
            new EnergyUpgrade(EnergyUpgradeManager.UPGRADE_NAME, 1, "enderio.darksteel.upgrade.empowered_two",
                    DarkSteelConfig.energyUpgradeLevelCostEmpowered1),
            new EnergyUpgrade(EnergyUpgradeManager.UPGRADE_NAME, 2, "enderio.darksteel.upgrade.empowered_three",
                    DarkSteelConfig.energyUpgradeLevelCostEmpowered2),
            new EnergyUpgrade(EnergyUpgradeManager.UPGRADE_NAME, 3, "enderio.darksteel.upgrade.empowered_four",
                    DarkSteelConfig.energyUpgradeLevelCostEmpowered3),
            new EnergyUpgrade(EnergyUpgradeManager.UPGRADE_NAME, 4, "enderio.darksteel.upgrade.empowered_five",
                    DarkSteelConfig.energyUpgradeLevelCostEmpowered4));
    ...
    public List<IRule> getRules() {
        return new NNList<>(Rules.withLevels(level, UPGRADES),
                ...
                (stack, item) -> item.getMaxEmpoweredLevel(stack) >= level ? IRule.CheckResult.PASS :
                        IRule.CheckResult.SILENT_FAIL);
    }

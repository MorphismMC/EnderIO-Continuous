...
public enum EquipmentData implements IEquipmentData {
    ...
    // Note maximum total armor value that has any effect at toughness 4*4 for damage=20 is 24. End steel comes up to
    // 25.
    ...
    private EquipmentData(int maxDamageFactor, @Nonnull int[] damageReduction, @Nonnull int[] damageReductionEmpowered,
                          int armorEnchantability,
                          SoundEvent soundEvent, float toughness, float toughnessEmpowered, String toolMaterialName,
                          int harvestLevel, int maxUses, float efficiency, float damage,
                          int toolEnchanability, @Nonnull String repairIngotOredict,
                          @Nonnull String bowRepairIngotOredict, @Nonnull String texture1, @Nonnull String texture2,
                          @Nonnull Integer tier, @Nonnull String textureShieldBase) {
        this.armorMaterial = NullHelper.notnullF(
                EnumHelper.addArmorMaterial(name(), name(), maxDamageFactor, damageReduction, armorEnchantability,
                        soundEvent, toughness),
                "Failed to create armor material");
        final String nameEmpowered = name() + "_EMPOWERED";
        this.armorMaterialEmpowered = NullHelper.notnullF(
                EnumHelper.addArmorMaterial(nameEmpowered, nameEmpowered, maxDamageFactor, damageReductionEmpowered,
                        armorEnchantability, soundEvent, toughnessEmpowered),
                "Failed to create empowered armor material");
        this.toolMaterial = NullHelper.notnullF(
                EnumHelper.addToolMaterial(toolMaterialName, harvestLevel, maxUses, efficiency, damage,
                        toolEnchanability),
    ...
    private EquipmentData(@Nonnull ArmorMaterial armorMaterial, @Nonnull ArmorMaterial armorMaterialEmpowered,
                          @Nonnull ToolMaterial toolMaterial,
                          @Nonnull String repairIngotOredict, @Nonnull String bowRepairIngotOredict,
                          @Nonnull String texture1, @Nonnull String texture2, @Nonnull Integer tier,

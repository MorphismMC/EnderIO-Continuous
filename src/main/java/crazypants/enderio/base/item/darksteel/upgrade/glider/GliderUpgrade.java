...
public class GliderUpgrade extends AbstractUpgrade implements IHasPlayerRenderer {
    ...
    public List<IRule> getRules() {
        return new NNList<>(Rules.forSlot(EntityEquipmentSlot.CHEST),
                Rules.not(Rules.withPrerequisite(ElytraUpgrade.INSTANCE)),
    ...
    public @Nonnull IRenderUpgrade getRender(@Nonnull AbstractClientPlayer player) {
        return StateController.isActive(player, this) ? GliderUpgradeLayer.instance :

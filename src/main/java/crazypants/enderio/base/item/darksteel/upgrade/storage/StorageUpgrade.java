...
public class StorageUpgrade extends AbstractUpgrade {
     ...
     **/
    protected static final @Nonnull EntityEquipmentSlot[] ARMOR = { EntityEquipmentSlot.HEAD, EntityEquipmentSlot.CHEST,
    ...
    // any armor item with this upgrade
    @Override
    @Nonnull
    public List<IRule> getRules() {
        return new NNList<>(
                Rules.or(Rules.forSlot(EntityEquipmentSlot.FEET), Rules.forSlot(EntityEquipmentSlot.LEGS),
                        Rules.forSlot(EntityEquipmentSlot.CHEST),
                        Rules.forSlot(EntityEquipmentSlot.HEAD)),
                EnergyUpgrade.HAS_ANY, Rules.withLevels(variant, INSTANCE, INSTANCE2, INSTANCE3),

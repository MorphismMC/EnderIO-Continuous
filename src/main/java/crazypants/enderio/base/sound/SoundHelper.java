...
public final class SoundHelper {
     ...
     * 
     */
    public static void playSound(World world, double soundLocationX, double soundLocationY, double soundLocationZ,
                                 ModSound sound, float volume, float pitch) {
        if (sound != null && sound.isValid()) {
            if (world instanceof WorldServer) {
                world.playSound(null, soundLocationX, soundLocationY, soundLocationZ, sound.getSoundEvent(),
                        sound.getSoundCategory(), volume, pitch);
            } else {
                world.playSound(soundLocationX, soundLocationY, soundLocationZ, sound.getSoundEvent(),
     ...
     * 
     */
    public static void playSound(World world, BlockPos soundLocation, ModSound sound, float volume, float pitch) {
     ...
     * <p>
     * 
     * See {@link SoundHelper#BLOCK_CENTER}, {@link SoundHelper#BLOCK_TOP} and {@link SoundHelper#BLOCK_LOW} for common
     * offsets.
     * 
     */
    public static void playSound(World world, BlockPos soundLocation, Vec3d offset, ModSound sound, float volume,
                                 float pitch) {
        playSound(world, soundLocation.getX() + offset.x, soundLocation.getY() + offset.y,
                soundLocation.getZ() + offset.z, sound, volume, pitch);
    }
     ...
     * 
     */
    public static void playSound(World world, Entity soundLocation, ModSound sound, float volume, float pitch) {

...
public class Potion extends LootFunction {
    ...
    public static class Serializer extends LootFunction.Serializer<Potion> {
        ...
        @Override
        public void serialize(@Nonnull JsonObject object, @Nonnull Potion functionClazz,
        ...
        @Override
        public @Nonnull Potion deserialize(@Nonnull JsonObject object,
                                           @Nonnull JsonDeserializationContext deserializationContext,
                                           @Nonnull LootCondition[] conditionsIn) {
            return new Potion(conditionsIn, JsonUtils.getString(object, "name"),
                    JsonUtils.getBoolean(object, "splash"));
        }
    }
}

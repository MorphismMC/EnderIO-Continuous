...
public class SetRandomUpgrade extends LootFunction {
    ...
    public static class Serializer extends LootFunction.Serializer<SetRandomUpgrade> {
        ...
        @Override
        public void serialize(@Nonnull JsonObject object, @Nonnull SetRandomUpgrade functionClazz,
                              @Nonnull JsonSerializationContext serializationContext) {}

        @Override
        public @Nonnull SetRandomUpgrade deserialize(@Nonnull JsonObject object,

...
public class SetRandomEnergy extends LootFunction {
    ...
    public static class Serializer extends LootFunction.Serializer<SetRandomEnergy> {
        ...
        @Override
        public void serialize(@Nonnull JsonObject object, @Nonnull SetRandomEnergy functionClazz,
                              @Nonnull JsonSerializationContext serializationContext) {}

        @Override
        public @Nonnull SetRandomEnergy deserialize(@Nonnull JsonObject object,

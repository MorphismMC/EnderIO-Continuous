...
public class PotionWithering {
    ...
    private static final @Nonnull PotionType withering = new PotionType(EnderIO.MODID + "." + NAME,
            new PotionEffect(MobEffects.WITHER, 900));
    private static final @Nonnull PotionType witheringLong = new PotionType(EnderIO.MODID + "." + NAME,
            new PotionEffect(MobEffects.WITHER, 2400));

...
public class PotionConfusion {
    ...
    private static final @Nonnull PotionType confusion = new PotionType(EnderIO.MODID + "." + NAME,
            new PotionEffect(MobEffects.NAUSEA, 900));
    private static final @Nonnull PotionType confusionLong = new PotionType(EnderIO.MODID + "." + NAME,
            new PotionEffect(MobEffects.NAUSEA, 2400));

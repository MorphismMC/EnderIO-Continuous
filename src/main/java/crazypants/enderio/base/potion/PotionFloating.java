...
public class PotionFloating {
    ...
    private static final @Nonnull PotionType floating = new PotionType(EnderIO.MODID + "." + NAME,
            new PotionEffect(MobEffects.LEVITATION, 7 * 20));
    private static final @Nonnull PotionType floatingStrong = new PotionType(EnderIO.MODID + "." + NAME,
            new PotionEffect(MobEffects.LEVITATION, 7 * 20, 2));
    private static final @Nonnull PotionType floatingLong = new PotionType(EnderIO.MODID + "." + NAME,
            new PotionEffect(MobEffects.LEVITATION, 28 * 20));

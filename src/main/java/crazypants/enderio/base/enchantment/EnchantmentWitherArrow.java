...
public final class EnchantmentWitherArrow extends EnchantmentBase {
    ...
    private EnchantmentWitherArrow() {
        super(NAME, EnchantmentConfig.witherArrowRarity, EnumEnchantmentType.BOW,
     ...
     * <p>
     * Correct: "Called whenever a mob is damaged and an item that has this enchantment on it is in the main hand, the
     * off hand or any armor slot." (MC-131637)
     */
    @Override
    public void onEntityDamaged(@Nonnull EntityLivingBase user, @Nonnull Entity entityHit, int level) {
        if (entityHit instanceof EntityLivingBase &&
                EnchantmentHelper.getEnchantmentLevel(this, user.getHeldItemMainhand()) > 0) {

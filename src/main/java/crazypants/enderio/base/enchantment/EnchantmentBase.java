...
public abstract class EnchantmentBase extends Enchantment implements IAdvancedEnchant {
    ...
    protected EnchantmentBase(@Nonnull String name, @Nonnull IValue<Rarity> rarityIn,
                              @Nonnull EnumEnchantmentType typeIn, @Nonnull IValue<Boolean> enableFlag) {
        this(name, rarityIn, typeIn, EntityEquipmentSlot.values(), enableFlag);
    }

    protected EnchantmentBase(@Nonnull String name, @Nonnull IValue<Rarity> rarityIn,
                              @Nonnull EnumEnchantmentType typeIn, @Nonnull EntityEquipmentSlot[] slots,

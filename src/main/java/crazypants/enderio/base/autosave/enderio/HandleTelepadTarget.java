...
public class HandleTelepadTarget implements IHandler<TelepadTarget> {
    ...
    public boolean store(@Nonnull Registry registry, @Nonnull Set<NBTAction> phase, @Nonnull NBTTagCompound nbt,
                         @Nonnull Type type, @Nonnull String name1,
                         @Nonnull TelepadTarget object) throws IllegalArgumentException, IllegalAccessException,
    ...
    @Override
    @Nullable
    public TelepadTarget read(@Nonnull Registry registry, @Nonnull Set<NBTAction> phase, @Nonnull NBTTagCompound nbt,
                              @Nonnull Type type,

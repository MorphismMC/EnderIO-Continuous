...
public class FluidFilterImpl implements FluidFilter {
    ...
    class FluidFilterGhostSlot extends GhostSlot implements IFluidGhostSlot {
        ...
        public boolean drawGhostSlotToolTip(@Nonnull GuiContainerBase gui, int mouseX, int mouseY) {
            ...
            if (stack != null && gui.mc.player.inventory.getItemStack().isEmpty()) {
                GuiUtils.drawHoveringText(Prep.getEmpty(),
                        Collections.singletonList(EnumRarity.COMMON.color + stack.getLocalizedName()), mouseX, mouseY,

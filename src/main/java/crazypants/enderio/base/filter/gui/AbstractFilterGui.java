...
public abstract class AbstractFilterGui extends GuiContainerBaseEIO<TileEntity>
                                        implements IHaveGhostTargets<AbstractFilterGui>, ICloseFilterRemoteExec.GUI {
    ...
    protected void drawGuiContainerBackgroundLayer(float par1, int mouseX, int mouseY) {
        ...
        fr.drawString(getUnlocalisedNameForHeading(), getGuiLeft() + 28, getGuiTop() + 13,
    ...
    public void sendFilterChange() {
        ...
        if (te != null) {
            PacketHandler.INSTANCE.sendToServer(new PacketFilterUpdate(te, getFilter(),
                    filterContainer.getFilterIndex(), filterContainer.getParam1()));
        } else {
            PacketHandler.INSTANCE
                    .sendToServer(new PacketHeldFilterUpdate(getFilter(), filterContainer.getFilterIndex()));
        }
    }

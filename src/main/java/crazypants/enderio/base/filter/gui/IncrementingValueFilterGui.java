...
public class IncrementingValueFilterGui extends AbstractFilterGui {
    ...
    public void renderCustomOptions(int top, float par1, int par2, int par3) {
        ...
        fr.drawString(incrementingFilter.getIncrementingValueName(), getGuiLeft() + xOffset, getGuiTop() + yOffset,
                ColorUtil.getRGB(Color.DARK_GRAY));
        String count = Integer.toString(incrementingFilter.getIncrementingValue());
        fr.drawString(" " + count, getGuiLeft() + xOffset + stringWidth, getGuiTop() + yOffset,
                ColorUtil.getRGB(Color.DARK_GRAY));

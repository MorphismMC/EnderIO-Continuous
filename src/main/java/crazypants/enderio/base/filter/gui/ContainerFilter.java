...
public class ContainerFilter extends ContainerEnderCap<EnderInventory, TileEntityBase>
                             implements ICloseFilterRemoteExec.Container {
    ...
    public IMessage doCloseFilterGui() {
        ...
        if (te != null) {
            ModObjectRegistry.getModObjectNN(te.getBlockType()).openGui(te.getWorld(), te.getPos(), player, dir,
                    getParam1());
        } else {
            player.closeScreen();
        }

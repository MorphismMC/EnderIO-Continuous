...
class Xptest {
    ...
    void testRisingPlayer() {
        ...
        while (i++ < 1000) {
            ...
            if (Log.isInDev()) {
                System.out.println("XP:" + assertDoesNotThrow(() -> XpUtil.getPlayerXP(player)) + " Level:" +
                        player.experienceLevel + " exp:" + player.experience + " barCap:" + player.xpBarCap() +
                        " exp*barcap:" + (player.experience * player.xpBarCap()) + " (int)exp*barcap:" +
    ...
    void testRisingPlayerWithFix() {
        ...
        while (i++ < 1000) {
            ...
            // if (Log.isInDev()) {
            // System.out.println("XP:" + XpUtil.getPlayerXP(player) + " Level:" + player.experienceLevel + " exp:" +
            // player.experience + " barCap:"
            ...
            assertTrue(i == assertDoesNotThrow(() -> XpUtil.getPlayerXP(player)) ||
                    (i - 1) == assertDoesNotThrow(() -> XpUtil.getPlayerXP(player)));
            assertEquals(i, player.experienceTotal);
